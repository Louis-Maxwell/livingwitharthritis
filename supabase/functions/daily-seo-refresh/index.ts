...
async function authorize(
  ...
  // Only the service-role key (used by the scheduled cron job) or an admin
  // JWT may trigger this expensive endpoint. The anon key is public and must
  // NOT be accepted here — it would let any visitor exhaust PSI quota.
