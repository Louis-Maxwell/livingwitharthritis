...
| 1.3 Security headers + CSP | ✅ Comprehensive | `cloudflare/worker.ts` applies HSTS preload, X-Frame DENY, nosniff, strict Permissions-Policy and cache policy; `index.html` carries the application CSP |
