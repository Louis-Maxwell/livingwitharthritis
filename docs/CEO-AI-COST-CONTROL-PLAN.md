...
This pull request already set the homepage tab title and main heading to
**Evidence-Based Health Guides**. That wording is kept on purpose.

On top of that:

- **Homepage tab title** in the live app matches the static page Google already
  sees (one shared title string).
