...
The homepage now names England, Scotland, Wales and Northern Ireland under the
hero, with tap-friendly links to PIP, waiting lists, diet, exercise, work
rights, donate and the blog. “Start here” includes PIP. Homepage FAQ answers
link through instead of dead-ending. The tab title matches the crawler title
so Google does not see two different names for the same page.
