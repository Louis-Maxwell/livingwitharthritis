...
Google had flagged some real pages as “soft 404” (looks empty to the crawler).
The support directory, blog, exercise article list, best-exercises FAQ,
sarcopenia guide, and ankylosing spondylitis exercise page now ship fuller
first HTML, short Q&As, and clearer on-page answers. After the usual publish
from `main`, open those addresses on your phone and check they still look like
your site — then in Google Search Console re-run Soft 404 validation for those
URLs.
