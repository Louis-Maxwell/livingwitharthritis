...
- **Spend rules** are back in writing so later work stays on Cursor/Claude.
- **Branded search plan** (already on this branch) stays the honest playbook
  for ranking first when someone types “Living With Arthritis”.
...
- **About** has a clear “Who we are” block: legal name, charity number,
