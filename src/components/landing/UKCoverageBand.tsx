...
const LINKS = [
  ...
  { href: "/guides/exercise", label: "Exercise" },
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-muted-foreground max-w-3xl leading-relaxed">
              We are a national charity. Our office is in Oswestry, Shropshire,
              but the guides are written for NHS care, NICE advice, and benefits
              in England, Scotland, Wales and Northern Ireland — not for one
              town only.
            </p>
          </div>
        </div>
