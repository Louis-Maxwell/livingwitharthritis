...
const LINKS = [
  { href: "/guides/benefits-pip", label: "PIP and benefits" },
...
/**
 * GEO strip: the charity serves the whole UK, not one town.
 * Do not publish a registered office address here (see docs/CUSTOMER-FIRST.md).
 */
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-muted-foreground max-w-3xl leading-relaxed">
              We are a national charity. The guides are written for NHS care,
              NICE advice, and benefits in England, Scotland, Wales and Northern
              Ireland — not for one town only.
            </p>
          </div>
        </div>
