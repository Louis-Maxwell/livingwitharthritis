    ...
    >
      <div className="relative grid lg:grid-cols-2 gap-0 items-center min-h-[65vh]">
        ...
        <div className="px-8 sm:px-12 lg:px-16 py-14 lg:py-0 space-y-6 text-center lg:text-left order-2 lg:order-1">
          <span className="inline-block text-xs font-bold tracking-[0.35em] uppercase text-primary-foreground">
            Connected Care
          </span>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 max-w-sm mx-auto lg:mx-0">
            {[
              ...
              <div key={s.label} className="text-center lg:text-left">
                <p className="text-2xl font-extrabold text-primary-foreground/90 tabular-nums">{s.val}</p>
                <p className="text-[11px] text-primary-foreground uppercase tracking-widest mt-0.5">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
