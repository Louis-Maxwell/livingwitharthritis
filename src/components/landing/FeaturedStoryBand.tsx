/**
 * FeaturedStoryBand
 * Inspired by Dogs Trust & Cats Protection landing pages — a single emotional
 * human story rendered as an editorial half-page spread: oversized portrait,
 * pull-quote, named contributor, contextual stats, and a soft CTA.
 */
...
const STORY_FACTS = [
  { kicker: "Age", value: "62" },
  { kicker: "Diagnosis", value: "Knee OA" },
  { kicker: "With us since", value: "Jan 2025" },
] as const;
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <figure className="lg:col-span-5 relative">
            ...
            <div className="relative rounded-sm overflow-hidden shadow-[0_30px_80px_-20px_hsl(var(--primary)/0.25)] aspect-[4/5] group">
              <img
                ...
                alt="Margaret, 62, smiling outdoors after her morning walk in Sheffield"
                width={1200}
                height={1500}
                loading="lazy"
                decoding="async"
          ...
          <div className="lg:col-span-7">
            ...
            <blockquote className="font-display text-[1.625rem] sm:text-[2rem] md:text-[2.5rem] lg:text-[2.75rem] leading-[1.15] tracking-[-0.02em] text-foreground text-balance mb-8">
              &ldquo;I was on the waiting list for sixteen months. Within a fortnight
              of starting here, I was walking the dog again — properly, without
              wincing.&rdquo;
            </blockquote>
