...
const faqs: { q: string; a: string; href?: string; linkLabel?: string }[] = [
  ...
  { q: "What are the first signs of osteoarthritis?", a: "Usually a dull ache during or after moving, stiffness in the morning that eases within half an hour, swelling, or a feeling of grating. Knees, hips and hands are most often the first joints to complain.", href: "/conditions/osteoarthritis", linkLabel: "Read the osteoarthritis guide" },
  { q: "Can I claim PIP for arthritis in the UK?", a: "PIP is assessed on how arthritis affects daily living and mobility, not on the diagnosis name. Scotland uses Adult Disability Payment instead of PIP. Citizens Advice can help with the form for free.", href: "/benefits-pip", linkLabel: "PIP and benefits guide" },
  { q: "Can I get a Blue Badge for arthritis?", a: "You may qualify if walking is substantially difficult. Local councils decide using national criteria. Our benefits guide explains how this sits alongside PIP and other support.", href: "/benefits-pip", linkLabel: "Blue Badge and benefits" },
