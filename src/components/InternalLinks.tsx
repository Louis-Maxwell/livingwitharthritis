...
const SITE_PAGES: SitePage[] = [
  ...
  { path: "/conditions/knee-arthritis", title: "Knee Arthritis", description: "Osteoarthritis of the knee — symptoms, exercises and surgical considerations.", icon: Activity, tags: ["condition", "knee", "osteoarthritis"] },
  { path: "/conditions/hip-arthritis", title: "Hip Arthritis", description: "OA and inflammatory arthritis of the hip joint — symptoms, exercise and treatment options.", icon: Activity, tags: ["condition", "hip", "osteoarthritis"] },
  { path: "/conditions/shoulder-arthritis", title: "Shoulder Arthritis", description: "OA and inflammatory arthritis of the shoulder — symptoms, exercises and when to seek referral.", icon: Activity, tags: ["condition", "shoulder", "osteoarthritis"] },
  { path: "/conditions/elbow-arthritis", title: "Elbow Arthritis", description: "Arthritis in the elbow joint — causes, symptoms and graded exercise guidance.", icon: Activity, tags: ["condition", "elbow", "osteoarthritis"] },
