...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <motion.div style={{ y: textY, opacity }} className="container relative mx-auto px-4 md:px-8 py-24 lg:py-0">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-4 items-center min-h-[80vh]">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            >
              <Button
                size="lg"
                className="group bg-white text-accent hover:bg-white/90 font-bold px-10 py-7 text-base rounded-full shadow-large transition-all duration-500 hover:shadow-[0_20px_60px_-15px_rgba(255,255,255,0.35)] hover:-translate-y-1 uppercase tracking-wider"
              >
                Get Started
              ...
              <Button
                size="lg"
                variant="outline"
                className="group border border-white/20 bg-white/5 backdrop-blur-md text-white hover:bg-white/10 hover:border-white/40 font-semibold px-10 py-7 text-base rounded-full transition-all duration-500"
              >
