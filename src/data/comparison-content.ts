...
// Each entry is 800â€“1200 words of evidence-informed, UK-focused copy.
...
export const COMPARISON_CONTENT: Record<string, ComparisonArticle> = {
  "/guides/paracetamol-vs-ibuprofen-for-arthritis": {
    ...
    metaDescription:
      "Which works better for arthritis pain â€” paracetamol or ibuprofen? A UK, NHS-aligned side-by-side comparison covering effectiveness, safety, cost and best-for scenarios.",
    intro:
    ...
    optionA: {
      ...
      cost: "Â£0.30â€“Â£2 for 16 tablets over the counter; free on UK healthcare prescription if exempt (~Â£9.90 charge otherwise).",
    },
    optionB: {
      name: "Ibuprofen",
      howItWorks:
      ...
      bestFor:
        "Inflammatory flare-ups, morning stiffness, painful osteoarthritis flares â€” especially in the knee, hand or hip.",
      sideEffects:
      ...
      cost: "Â£0.50â€“Â£3 for 16 tablets; topical gel around Â£4â€“Â£8 a tube.",
    },
    sections: [
      {
        heading: "How each one actually works",
        paragraphs: [
          "Paracetamol's mechanism is still debated, but its main effect is in the central nervous system, dampening how pain signals are processed. Crucially, it barely touches inflammation â€” so it can take the edge off aching joints but doesn't shrink swollen ones.",
      ...
      {
        heading: "Safety â€” where the differences really show",
        paragraphs: [
          "Paracetamol is remarkable in that, at the correct dose, most people can take it long-term with minimal issues. The main risk is overdose â€” deliberate or accidental â€” which can silently damage the liver.",
          "Ibuprofen and other NSAIDs carry more day-to-day risk. Even short courses can raise blood pressure, worsen heart failure, irritate the stomach or reduce kidney function â€” particularly in people over 65, on blood pressure or diuretic medication, or with kidney disease. Regular users are often prescribed a proton pump inhibitor (PPI) like omeprazole to protect the stomach lining.",
      ...
      },
      {
        ...
        paragraphs: [
          "Both are cheap. A pack of 16 tablets of either is under Â£3 in most UK supermarkets and pharmacies. On UK healthcare prescription in England a single item costs Â£9.90 (2024/25), so buying either over the counter is usually cheaper unless you have an exemption or a Prescription Prepayment Certificate.",
      ...
      },
      {
        ...
        paragraphs: [
          "For a flare with obvious swelling, warmth and stiffness, ibuprofen (topical first, oral if needed) is usually the more effective option â€” provided you can tolerate it. For general aching without much swelling, or if NSAIDs are risky for you, paracetamol is still a sensible option, even if the strength of evidence for osteoarthritis is modest.",
    ...
    table: [
      { label: "Reduces inflammation?", a: "No â€” mostly a painkiller", b: "Yes â€” anti-inflammatory" },
      ...
      { label: "OTC cost (16 tablets)", a: "Â£0.30â€“Â£2", b: "Â£0.50â€“Â£3" },
      { label: "UK healthcare prescription (England)", a: "Â£9.90 per item", b: "Â£9.90 per item" },
    ],
    takeaways: [
      ...
      "Neither drug slows arthritis â€” inflammatory arthritis needs DMARDs or biologics.",
    ],
  },
  ...
  "/guides/osteoarthritis-vs-rheumatoid-arthritis": {
    ...
    metaDescription:
      "Osteoarthritis vs rheumatoid arthritis explained â€” how they differ in cause, symptoms, tests, treatment and long-term outlook, written for UK patients.",
    intro:
      "Osteoarthritis (OA) and rheumatoid arthritis (RA) are the two most common forms of arthritis in the UK, but they are very different diseases. Confusing them delays the right treatment â€” particularly for rheumatoid arthritis, where early diagnosis genuinely changes outcomes. This guide compares them side-by-side, using UK healthcare and NICE frameworks, so you can recognise which pattern fits and what to ask your GP.",
    optionA: {
      name: "Osteoarthritis (OA)",
      howItWorks:
        "A wear-and-repair disorder of the joint â€” the cartilage thins, the bone underneath remodels and small bony spurs (osteophytes) form.",
      bestFor:
        "'Best for' doesn't apply â€” this describes people typically affected: over 45, often after injury, obesity or years of joint load.",
      sideEffects:
    ...
    optionB: {
      ...
      howItWorks:
        "An autoimmune disease â€” the immune system attacks the joint lining (synovium), causing chronic inflammation and, if untreated, joint erosion.",
      bestFor:
        "Typically develops between 40â€“60 (though possible at any age), three times more common in women, often with a family history.",
      sideEffects:
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Osteoarthritis is a disorder of the joint itself. Cartilage â€” the smooth cap on bone ends â€” gradually thins and cracks, and the underlying bone tries to compensate by thickening and growing osteophytes. It's driven by mechanical load, past injury, genetics and body weight, and typically affects weight-bearing joints (knees, hips, spine) and the small joints of the hand.",
          "Rheumatoid arthritis is a systemic autoimmune disease. The immune system attacks the synovium â€” the thin lining of every movable joint â€” creating persistent inflammation that erodes cartilage and bone if left uncontrolled. It usually starts symmetrically in small joints (knuckles, wrists, base of toes) and can affect the whole body: fatigue, weight loss, lung and eye involvement.",
        ],
      },
      {
        heading: "Symptoms clues that point one way or the other",
        paragraphs: [
          "Timing of stiffness is one of the most useful clues. OA stiffness is short â€” usually under 30 minutes on waking and after inactivity â€” and joints feel better with gentle movement then worse with heavy use. RA stiffness lasts more than an hour, sometimes most of the morning, and improves with movement.",
          ...
          "Swelling in OA is bony and hard (Heberden's and Bouchard's nodes on finger joints). In RA it is soft and boggy â€” the inflamed synovium â€” with visible warmth.",
        ],
      },
      {
        heading: "How UK doctors tell them apart",
        paragraphs: [
          "GPs diagnose osteoarthritis clinically in adults over 45 with typical activity-related joint pain and short morning stiffness â€” no imaging or blood tests are needed unless the picture is unusual.",
      ...
      },
      {
        ...
        paragraphs: [
          "OA treatment aims to protect the joint and control symptoms. That means muscle-strengthening and aerobic exercise, weight management if relevant, topical NSAID gel, oral NSAIDs (short courses), and â€” for advanced cases â€” joint replacement, which is one of the most successful operations the UK healthcare system performs.",
          "RA treatment aims to switch the disease off. DMARDs â€” usually methotrexate â€” are started as soon as possible, with a 'treat-to-target' approach: measure activity every few months and step treatment up (adding hydroxychloroquine, sulfasalazine, then biologics) until inflammation is under control. Early, aggressive treatment often prevents lasting joint damage.",
        ],
      },
      {
    ...
    table: [
      ...
      { label: "Typical age", a: "Usually 45+", b: "Any age, often 40â€“60" },
      ...
      { label: "Systemic symptoms", a: "No", b: "Yes â€” fatigue, sometimes lung, eye" },
    ],
    takeaways: [
      "OA is a joint disease; RA is a whole-body autoimmune disease.",
      "Long morning stiffness and symmetric small-joint swelling point to RA â€” see your GP quickly.",
      ...
      "Exercise helps both â€” but never replaces DMARDs in inflammatory arthritis.",
    ],
  },
  ...
  "/guides/dmards-vs-biologics": {
    ...
    metaDescription:
      "DMARDs vs biologics â€” how they differ in how they work, who gets them on the UK healthcare system, side-effects and cost. A plain-English UK guide.",
    intro:
      "For rheumatoid, psoriatic and axial spondyloarthritis, DMARDs and biologics are the two families of medicines that actually change the disease. They are not painkillers â€” they suppress the immune activity driving joint damage. This guide compares them for UK patients navigating UK healthcare rheumatology.",
    optionA: {
      ...
      cost: "Very cheap â€” methotrexate tablets cost the UK healthcare system pennies per week.",
    },
    optionB: {
      name: "Biologics",
      howItWorks:
        "Target one specific step of the immune response â€” TNF, IL-6, IL-17, JAK, B cells â€” using engineered proteins or small molecules.",
      bestFor:
      ...
      cost: "Â£8,000â€“Â£15,000+/year â€” usually free to eligible UK healthcare patients; biosimilars have reduced the price significantly.",
    },
    sections: [
      {
        heading: "How the two families really differ",
        paragraphs: [
          "Conventional DMARDs are old-school immune suppressants: they slow down a wide range of immune activity, which is why they work but also why they need blood monitoring. Methotrexate â€” the most-used arthritis medicine in the world â€” is safe and effective for most people at once-weekly doses.",
          "Biologics are precision tools. Instead of dampening the whole immune system, they block one signal â€” for example TNF-Î± (adalimumab, etanercept, infliximab), IL-6 (tocilizumab), IL-17 (secukinumab) or B-cells (rituximab). Newer 'targeted synthetic DMARDs' (JAK inhibitors like tofacitinib and baricitinib) are tablets rather than injections but work in the same targeted way.",
        ],
      },
      {
        heading: "How the UK healthcare system decides who gets what",
        paragraphs: [
          "NICE sets clear criteria. For rheumatoid arthritis, biologics are approved after a person has failed to respond to at least two conventional DMARDs (one of which is usually methotrexate) and still has moderate to severe disease activity â€” measured by DAS28 score. Similar rules apply to psoriatic arthritis and ankylosing spondylitis.",
          "This means most UK patients start on methotrexate, add hydroxychloroquine or sulfasalazine, and only move to biologics if disease activity stays high. It's not a matter of newer being 'better' â€” for a large minority of patients, DMARDs alone give excellent control.",
        ],
      },
      {
        heading: "Side-effect trade-offs",
        paragraphs: [
          "DMARDs need regular blood tests (fortnightly at start, then every 8â€“12 weeks) to catch liver, kidney or blood-count problems early. Common day-to-day side-effects â€” nausea, mouth ulcers, tiredness the day after methotrexate â€” often improve with folic acid, dose splitting or an anti-sickness tablet.",
      ...
      },
      {
        ...
        paragraphs: [
          "For most newly-diagnosed rheumatoid arthritis, methotrexate remains the anchor drug â€” often combined with a short course of steroids to bridge until it kicks in. Roughly half of patients get durable low disease activity or remission on DMARDs alone.",
    ...
    table: [
      ...
      { label: "UK healthcare cost/year", a: "Under Â£100", b: "Â£8,000â€“Â£15,000+" },
      { label: "Access on NHS", a: "Freely prescribed", b: "NICE criteria required" },
    ],
    takeaways: [
      "Most UK patients start on methotrexate â€” cheap, effective, and well understood.",
  ...
  "/guides/swimming-vs-walking-arthritis": {
    ...
    metaDescription:
      "Swimming vs walking for arthritis â€” which helps more, which is safer for painful joints, and what UK guidance recommends.",
    intro:
      "Regular movement is one of the most powerful treatments for arthritis â€” the closest thing to a wonder drug. But when joints hurt, choosing the right kind of movement matters. This guide compares swimming and walking side-by-side for UK arthritis patients, drawing on UK healthcare and Versus Arthritis guidance.",
    optionA: {
      ...
      cost: "Â£4â€“Â£7 a public swim; Â£30â€“Â£50 monthly gym membership; UK healthcare hydrotherapy free but usually short courses.",
    },
    optionB: {
      name: "Walking",
      howItWorks:
      ...
      cost: "Essentially free â€” you already have shoes.",
    },
    sections: [
      {
        heading: "The joint-load question",
        paragraphs: [
          "The single biggest difference between swimming and walking is joint load. Chest-deep water reduces effective body weight by around 75%, and neck-deep water by around 90%. That's why hydrotherapy pools are heated and used specifically for people whose joints can't tolerate normal exercise â€” after a knee replacement, during a rheumatoid flare, or when hip osteoarthritis makes even a short walk painful.",
          "Walking, by contrast, loads each knee with about 1.5 times body weight per step. That's usually fine for mild osteoarthritis and actually helps cartilage stay healthy through 'load and unload' cycles â€” but it can be too much during a flare or with badly deconditioned muscles.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Cardiovascular benefits are comparable at equivalent intensity. Where the two really diverge is bone density: walking preserves bone through mechanical loading, while swimming â€” pleasant as it is â€” does not. Post-menopausal women and anyone at risk of osteoporosis should ideally include some weight-bearing exercise even if they primarily swim.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Swimming has real barriers: getting to a pool, changing rooms, hair care, cost and â€” for some â€” anxiety about being in a swimming costume. Walking removes almost all of those. On the other hand, walking in a British winter with icy pavements is riskier for anyone unsteady on their feet.",
      ...
      },
      {
        ...
        paragraphs: [
          "Hip and knee osteoarthritis often favour swimming as the primary exercise, particularly during flares. Back arthritis and mild lower-limb OA usually do very well with walking. Hand and wrist arthritis? Neither is particularly targeted, but both help general fitness â€” pair with specific hand exercises from a physiotherapist.",
          "If your pain rises by more than two points on a 0â€“10 scale during exercise, or is still worse the next morning, reduce intensity rather than stop entirely. That's not a sign to give up; it's a sign to adjust.",
        ],
      },
    ],
    table: [
      ...
      { label: "Typical cost", a: "Â£4â€“Â£7 per session", b: "Free" },
    ],
    takeaways: [
      ...
      "Combining both â€” pool weekly, walk daily â€” suits many arthritis patients.",
  ...
  "/guides/heat-vs-cold-arthritis-pain": {
    ...
    optionA: {
      ...
      cost: "Â£5â€“Â£20 for a wheat bag, hot water bottle or reusable heat pad.",
    },
    optionB: {
      name: "Cold therapy",
      howItWorks:
      ...
      cost: "Â£0 (frozen peas!) to Â£15 for a reusable gel pack.",
    },
    sections: [
      {
        heading: "What heat and cold actually do",
        paragraphs: [
          "Heat opens up local blood vessels, brings warm blood to stiff tissue and helps muscles relax. It also reduces the sensitivity of pain receptors â€” a temporary but real effect. That's why a hot shower in the morning is often the single most helpful thing for rheumatoid or ankylosing spondylitis stiffness.",
      ...
      },
      {
        ...
        paragraphs: [
          "If the joint is stiff and achy, choose heat. If it is hot, swollen and angry, choose cold. If it's both â€” say, an osteoarthritic knee that's been overused â€” most people find alternating heat and cold sessions helps.",
      ...
      },
      {
        ...
        paragraphs: [
          "For heat: aim for pleasantly warm, not scalding. 15â€“20 minutes at a time, with a towel or clothing between skin and the heat source. Never sleep with an electric blanket or heat pad on. Avoid heat on skin with reduced sensation (from neuropathy or after some steroid injections).",
          "For cold: wrap an ice pack or bag of frozen peas in a thin tea towel â€” never straight onto the skin. 10â€“15 minutes maximum, with at least an hour off between applications. Skip cold on numb areas, on Raynaud's-affected fingers, or if you have poor circulation.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Neither modality changes the underlying disease. They are self-management tools that make daily life more bearable and can reduce reliance on painkillers â€” a genuinely useful thing given NSAID risks in older adults.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Contrast bathing â€” alternating warm and cold water â€” is popular anecdotally for hand and foot arthritis, though evidence is limited. If it feels good and skin tolerates it, it's harmless.",
        ],
      },
    ],
    table: [
      ...
      { label: "Typical session", a: "15â€“20 min", b: "10â€“15 min" },
      { label: "Cost", a: "Â£5â€“Â£20", b: "Â£0â€“Â£15" },
  ...
  "/guides/mediterranean-diet-vs-anti-inflammatory-diet": {
    ...
    metaDescription:
      "Mediterranean diet vs anti-inflammatory diet for arthritis â€” how they overlap, where they differ, and what UK evidence really supports.",
    intro:
      "'Anti-inflammatory' has become a marketing word attached to almost every food trend. The Mediterranean diet is one of the few eating patterns with genuinely strong evidence for reducing arthritis pain and cardiovascular risk. This guide compares the two, for UK readers who want to eat in a way that actually helps their joints â€” without buying Â£40 supplements.",
    optionA: {
      ...
      cost: "Â£40â€“Â£70 per person per week; overlaps with normal UK shopping.",
    },
    optionB: {
      name: "'Anti-inflammatory' diet",
      howItWorks:
        "Not a single defined pattern â€” usually a set of principles emphasising oily fish, turmeric, ginger, berries, leafy greens, while cutting sugar, ultra-processed food and, sometimes, gluten or nightshades.",
      bestFor:
    ...
    sections: [
      {
        ...
        paragraphs: [
          "In practice, most versions of 'anti-inflammatory eating' are 90% Mediterranean plus a few extras â€” turmeric, ginger, green tea, sometimes limiting nightshades, wheat or dairy. Both patterns emphasise vegetables, fruit, nuts, seeds, oily fish, olive oil and legumes, and both discourage ultra-processed food, sugary drinks and excess red or processed meat.",
          "The real difference is that the Mediterranean diet is defined by decades of research â€” including large randomised trials like PREDIMED â€” whereas 'anti-inflammatory' as a label is looser and often driven by supplement marketing.",
        ],
      },
      {
        heading: "What the arthritis evidence actually shows",
        paragraphs: [
          "For rheumatoid arthritis, several trials of Mediterranean-style eating show modest but real reductions in joint pain, tender joint count and CRP. Effects are smaller than DMARDs but real, and improve cardiovascular risk â€” important because RA itself raises heart-attack risk.",
      ...
      },
      {
        ...
        paragraphs: [
          "Some anti-inflammatory approaches recommend cutting nightshades (tomatoes, aubergine, peppers, potatoes), gluten or dairy. There is no consistent evidence these help arthritis in general â€” although a small subset of people with coeliac disease or genuine intolerances do improve. Blanket elimination risks nutritional gaps and lower quality of life.",
          "Some approaches lean heavily on supplements â€” turmeric capsules, high-dose fish oil, MSM, glucosamine. The evidence for these is patchy: high-dose omega-3 has modest RA benefit; curcumin has some knee osteoarthritis trials; glucosamine's effect is small and inconsistent.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "If you want to add 'anti-inflammatory' extras, safe additions are turmeric with black pepper in cooking, fresh or powdered ginger, and green tea. Skip the Â£30 pill bottles unless a rheumatologist or dietitian specifically recommends them.",
        ],
      },
      {
        heading: "What to prioritise if you can only change one thing",
        paragraphs: [
          "For arthritis, the highest-yield change is usually: eat oily fish twice a week, swap sunflower/vegetable oil for olive oil, and eat vegetables at every meal. Do just that and you're already Mediterranean, already anti-inflammatory, and likely to feel a difference over 8â€“12 weeks.",
  ...
  "/guides/nhs-vs-private-rheumatology": {
    ...
    metaDescription:
      "UK healthcare vs private rheumatology â€” waiting times, costs, medication access and what genuinely changes if you go private in the UK.",
    intro:
      "Getting rheumatology care in the UK usually means the UK healthcare system, but private appointments can shorten waits and give you more choice over your consultant. This guide compares both routes honestly, so you can decide whether â€” and when â€” private is worth it.",
    optionA: {
      ...
      bestFor:
        "The overwhelming majority of patients â€” care is high-quality and complete, if slower than private.",
      sideEffects:
        "Long waits (often 12â€“30+ weeks for first appointment), less continuity of consultant, limited appointment times.",
      nhs: "Universal, free at the point of use for UK residents.",
      cost: "Â£0 to the patient (prescription charges may apply in England).",
    },
    optionB: {
      ...
      nhs: "Runs alongside UK healthcare â€” most rheumatologists work in both.",
      cost: "Â£200â€“Â£350 first appointment, Â£150â€“Â£250 follow-ups, plus tests and imaging (often Â£150â€“Â£500).",
    },
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Privately, you get a longer first appointment (typically 45â€“60 minutes), quick access to ultrasound or MRI, and the same consultant every time. The clinical decisions look very similar â€” most private rheumatologists work in the UK healthcare system too and follow the same guidelines.",
        ],
      },
      {
        heading: "Waiting times â€” the real reason people go private",
        paragraphs: [
          "In parts of the UK the wait for an UK healthcare first rheumatology appointment can be 20+ weeks, and longer for follow-up scans. When early inflammatory arthritis is suspected, that delay matters â€” every extra month before starting DMARDs adds a small but measurable risk of joint damage.",
          "A private first appointment is often available within 5â€“10 working days. If bloods and ultrasound confirm inflammation, a private consultant can start DMARDs immediately (usually on private prescription initially).",
        ],
      },
      {
        heading: "The medication transfer question",
        paragraphs: [
          "For most patients this is where private care gets complicated. Methotrexate and other conventional DMARDs can usually be transferred back to your UK healthcare GP as a 'shared care' arrangement, saving hundreds of pounds a year. Not all GP surgeries accept shared care immediately â€” it depends on local guidelines.",
      ...
      {
        heading: "Cost â€” being realistic",
        paragraphs: [
          "A first private consultation is typically Â£200â€“Â£350; follow-ups Â£150â€“Â£250. Add Â£50â€“Â£150 for bloods, Â£150â€“Â£400 for MRI or ultrasound. So a full private diagnostic workup often costs Â£500â€“Â£1,000 before treatment starts.",
          "Some private health insurance policies cover this; some specifically exclude chronic conditions once diagnosed. Read the policy wording carefully â€” you cannot 'insure yourself' for arthritis after you're already diagnosed.",
        ],
      },
      {
        heading: "When private is worth it â€” and when it isn't",
        paragraphs: [
          ...
          "Private is usually not worth it if: you already have a diagnosis and an UK healthcare team; your treatment is stable; you only want private for 'comfort' rather than clinical urgency. The clinical decisions won't differ â€” you'd just be paying for the same guideline-based care faster.",
        ],
      },
      {
    ...
    table: [
      { label: "First appointment wait", a: "12â€“30+ weeks", b: "Within 1â€“2 weeks" },
      { label: "First appointment cost", a: "Â£0", b: "Â£200â€“Â£350" },
      { label: "Consultant continuity", a: "Variable", b: "Same consultant" },
      { label: "Imaging access", a: "Weeksâ€“months", b: "Days" },
  ...
  "/guides/collagen-vs-glucosamine": {
    ...
    optionA: {
      ...
      nhs: "Not prescribed on the UK healthcare system for arthritis. NICE does not recommend it, but it is not discouraged either â€” considered a personal choice.",
      cost: "Â£10â€“Â£25 per month for a 10 g/day hydrolysed collagen powder or peptide capsules.",
    },
    optionB: {
      ...
      bestFor:
        "Mild to moderate knee osteoarthritis, particularly in people willing to trial a supplement for at least 8â€“12 weeks before judging effect.",
      sideEffects:
      ...
      cost: "Â£8â€“Â£20 per month for 1,500 mg/day glucosamine sulfate; combined glucosamine + chondroitin products cost more (Â£15â€“Â£30).",
    },
    sections: [
      {
        heading: "What each one actually is",
        paragraphs: [
          "Collagen is the main structural protein in cartilage, tendon, skin and bone. Supplements are almost always 'hydrolysed collagen' or 'collagen peptides' â€” long chains broken down into short fragments the gut can absorb. Sources are usually bovine (cow hide), marine (fish skin) or, less commonly, chicken (type II collagen).",
          "Glucosamine is a natural amino sugar the body uses to build the sticky, cushioning parts of cartilage (glycosaminoglycans). Supplements are extracted mainly from shellfish shells, though shellfish-free versions from fermented corn are now available. The sulfate form is the one used in most positive trials â€” the hydrochloride form has weaker evidence.",
        ],
      },
      {
        heading: "What the evidence actually shows",
        paragraphs: [
          "For glucosamine, the picture is genuinely mixed. Early European trials of pharmaceutical-grade glucosamine sulfate (usually 1,500 mg once daily) reported modest but real improvements in knee osteoarthritis pain and function over 6 months. Larger, more rigorous US trials (notably GAIT, 2006) found no meaningful difference over placebo. The most likely explanation is that a subset of people â€” often those with moderate knee OA â€” respond, while others don't. That's why NICE 2022 no longer recommends it routinely, but many patients still find it useful.",
          "For collagen, the evidence is younger but more consistently positive for symptoms. Randomised trials of 10 g/day hydrolysed collagen or 40 mg/day undenatured type II collagen have shown reductions in knee OA pain and stiffness after 3â€“6 months, with effect sizes broadly comparable to glucosamine in some head-to-head studies. A 2019 meta-analysis in the International Journal of Rheumatic Diseases concluded collagen hydrolysate produced a significant reduction in joint pain versus placebo. Study sizes are still smaller than the glucosamine literature, so cautious optimism is the fair read.",
          "Neither supplement has been shown to slow the underlying structural progression of osteoarthritis reliably. What they may do is reduce symptoms â€” pain, stiffness, morning discomfort â€” enough to keep you active, which is itself protective.",
        ],
      },
      {
        heading: "How quickly you'd notice a difference",
        paragraphs: [
          "Both supplements work slowly. Neither is a painkiller. A fair trial period is 8â€“12 weeks at a proper dose, taken daily. If you've had no benefit at all by three months, it's unlikely to start working later â€” stop and try something else.",
          "Collagen often shows its earliest effects on non-joint tissues (skin firmness, nail strength, tendon comfort) within 4â€“6 weeks, with joint benefits appearing later. Glucosamine tends to be joint-specific â€” you either notice a reduction in that background knee ache after 6â€“10 weeks or you don't.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Collagen: 10 g/day of hydrolysed collagen peptides is the dose used in most positive trials, taken in water, coffee or a smoothie. Undenatured type II collagen (UC-II) uses a much smaller dose â€” 40 mg/day â€” and works by a different immune-modulating mechanism.",
        ],
      },
      {
        heading: "Safety, allergies and interactions",
        paragraphs: [
          "Both are among the safer supplements on the market, but not risk-free. Glucosamine can raise INR in people on warfarin â€” a genuine bleeding risk that's easy to miss. It may also nudge fasting glucose slightly higher, which matters if diabetes is poorly controlled. Anyone with a serious shellfish allergy should use a shellfish-free (fermented) glucosamine.",
      ...
      },
      {
        ...
        paragraphs: [
          "If your main problem is knee osteoarthritis pain and you want the option with the longest evidence base â€” even if that evidence is mixed â€” start with 1,500 mg/day glucosamine sulfate for 12 weeks. It's the cheaper of the two, and if you're going to respond, you'll likely know by then.",
          ...
          "Some people take both. There's no known interaction and no reason not to â€” but it doubles the monthly cost, so it's worth trialling them one at a time first to see which (if either) is actually doing something for you.",
        ],
      },
    ],
    table: [
      { label: "Typical UK dose", a: "10 g/day hydrolysed peptides", b: "1,500 mg/day sulfate" },
      { label: "Time to judge effect", a: "8â€“12 weeks", b: "8â€“12 weeks" },
      ...
      { label: "Monthly cost", a: "Â£10â€“Â£25", b: "Â£8â€“Â£20" },
  ...
  "/guides/febuxostat-vs-allopurinol": {
    ...
    optionA: {
      name: "Allopurinol",
      howItWorks:
        "Xanthine oxidase inhibitor. Lowers uric acid production. Standard first-line urate-lowering therapy in UK guidelines, titrated from 100 mg up to 900 mg/day to hit a target serum urate below 300â€“360 Âµmol/L.",
      bestFor:
      ...
      cost: "Approximately Â£1â€“Â£3 per month at standard doses. Free with an UK healthcare prescription exemption.",
    },
    optionB: {
      name: "Febuxostat",
      howItWorks:
      ...
      cost: "Roughly Â£13â€“Â£20 per month for 80 mg tablets. Free with an UK healthcare prescription exemption.",
    },
    sections: [
      {
        ...
        paragraphs: [
          ...
          "This is not because febuxostat is a worse drug â€” it isn't. It reflects cost, decades of allopurinol safety data, and the unresolved cardiovascular question from the CARES trial. If allopurinol is well tolerated and reaches the target serum urate, there is no reason to switch.",
        ],
      },
      {
        heading: "Effectiveness â€” reaching the target urate",
        paragraphs: [
          "The whole point of urate-lowering therapy is to drop serum urate below 300â€“360 Âµmol/L (5â€“6 mg/dL) and keep it there. Below that threshold, existing urate crystals in joints slowly dissolve and new attacks become rare.",
          "At its full titrated dose (up to 900 mg/day, though most UK patients reach target on 300â€“500 mg), allopurinol gets 70â€“80% of people to target. The problem is that many are left under-treated on 100â€“300 mg because their GP doesn't titrate high enough.",
          "Febuxostat at 80 mg or 120 mg once daily reaches target urate in more people at a fixed dose than allopurinol 300 mg does â€” but the fair comparison is against properly titrated allopurinol, and there the difference narrows significantly.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "People of Han Chinese, Thai or Korean ancestry are offered HLA-B*5801 testing before starting allopurinol because that gene raises the risk of severe cutaneous reactions (Stevensâ€“Johnson syndrome). A positive test is a clear indication for febuxostat instead.",
        ],
      },
      {
        heading: "Kidney disease â€” a real difference",
        paragraphs: [
      ...
      {
        heading: "Starting either drug â€” the flare paradox",
        paragraphs: [
          "Both drugs frequently trigger gout attacks in the first weeks of treatment as urate crystals start to dissolve and shed from joints. This is expected, not a treatment failure. UK guidance recommends covering the first 3â€“6 months of urate-lowering therapy with a low-dose colchicine (usually 500 micrograms once or twice daily) or a low-dose NSAID if colchicine is not tolerated.",
          "The most common reason people stop urate-lowering therapy is stopping in the middle of an early flare. If your urate is coming down, do not stop the drug â€” that's when the flares are most likely, but also when the long-term benefit is beginning.",
        ],
      },
      {
        heading: "So which should you take?",
        paragraphs: [
          "For almost all UK adults with gout, allopurinol first â€” titrated properly to hit a serum urate target below 360 Âµmol/L. This is the NICE- and BSR-recommended route, it is far cheaper, and it has the longest safety record.",
    ...
    table: [
      ...
      { label: "Typical dose", a: "100 â†’ 300â€“900 mg/day, titrated", b: "80 mg or 120 mg once daily" },
      { label: "Reaches urate target", a: "70â€“80% when properly titrated", b: "Higher at fixed dose vs allopurinol 300 mg" },
      { label: "Renal impairment", a: "Slow titration; capped in severe CKD", b: "No adjustment mildâ€“moderate CKD" },
      { label: "Cardiovascular safety", a: "Preferred where CV disease present", b: "Signal in CARES, not confirmed in FAST" },
      { label: "Cost per month (NHS)", a: "Â£1â€“Â£3", b: "Â£13â€“Â£20" },
      { label: "Serious rash risk", a: "Rare; test HLA-B*5801 in at-risk ancestry", b: "Lower than allopurinol" },
    ],
    takeaways: [
      "Allopurinol is first-line urate-lowering therapy in the UK â€” titrate to a serum urate below 360 Âµmol/L.",
      ...
      "Both drugs commonly trigger flares in the first weeks â€” cover with low-dose colchicine or NSAID for 3â€“6 months.",
      ...
      "Do not stop urate-lowering therapy during an early flare â€” that's when it's starting to work.",
    ],
  },
};
...
export const COMPARISON_META_DESCRIPTIONS: Record<string, string> = {
  ...
  "/guides/glucosamine-vs-turmeric-arthritis":
    "Glucosamine vs turmeric for arthritis: what the evidence actually shows for joint pain, typical UK doses, side effects and interactions â€” and which is worth trying first.",
