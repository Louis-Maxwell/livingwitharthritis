...
// UK-focused (UK healthcare terminology where relevant). Keep entries 50â€“100 words.
// Fallback UI applies when a slug is not defined here.

export interface GlossaryEntry {
  /** Display label â€” overrides the slug-derived label when set. */
  label: string;
  /** Short one-line summary shown in listings. */
  short: string;
  /** Full definition, 50â€“100 words. Plain-English, UK-focused. */
  body: string;
...
export const GLOSSARY_CONTENT: Record<string, GlossaryEntry> = {
  dmard: {
    label: "DMARD",
    short:
      "Disease-modifying anti-rheumatic drug â€” slows autoimmune arthritis damage rather than just easing pain.",
    body:
      "DMARD stands for Disease-Modifying Anti-Rheumatic Drug. Unlike painkillers, DMARDs damp down the overactive immune response driving conditions like rheumatoid, psoriatic and juvenile arthritis, which slows joint damage over months. Conventional DMARDs include methotrexate, sulfasalazine, hydroxychloroquine and leflunomide â€” nearly always started by an UK healthcare rheumatologist, then monitored with regular blood tests. They typically take 6â€“12 weeks to work. If they don't control disease activity, the team may add or switch to a biologic or targeted synthetic DMARD.",
  ...
  esr: {
    label: "ESR",
    short:
      "Erythrocyte sedimentation rate â€” a blood test that goes up when the body is inflamed.",
    body:
  ...
  remission: {
    ...
    body:
      "Remission means inflammatory arthritis activity has dropped low enough that a person has little or no joint pain or swelling, normal function, and near-normal inflammatory markers (CRP/ESR). UK rheumatology teams aim for remission â€” or at least low disease activity â€” using a 'treat to target' approach: measure activity every few months and step treatment up until targets are met. Achieving early remission protects joints from long-term damage and often lets people stay in work and normal life.",
  ...
  seronegative: {
    ...
    body:
      "'Seronegative' means the standard rheumatoid antibodies â€” rheumatoid factor and anti-CCP â€” are not detectable in the blood. Some people with rheumatoid arthritis are seronegative and tend to have milder disease; the umbrella term 'seronegative spondyloarthritis' also covers ankylosing spondylitis, psoriatic arthritis, reactive arthritis and enteropathic arthritis, which share features like enthesitis, HLA-B27 links and back involvement rather than classic rheumatoid antibodies.",
    related: ["rheumatoid-factor", "anti-ccp", "hla-b27", "enthesitis"],
  },
  enthesitis: {
    label: "Enthesitis",
    short:
      "Inflammation where a tendon or ligament joins onto bone â€” a hallmark of spondyloarthritis.",
    body:
      "Enthesitis is inflammation of an enthesis â€” the point where a tendon, ligament or joint capsule attaches to bone. Common sites include the Achilles tendon, plantar fascia, elbow and around the pelvis. Painful, tender entheses that don't settle are a hallmark of the spondyloarthritis family (ankylosing, psoriatic and reactive arthritis) and help distinguish it from rheumatoid arthritis, which mostly targets the joint lining (synovium).",
    related: ["dactylitis", "hla-b27", "seronegative"],
  },
  dactylitis: {
    label: "Dactylitis",
    short:
      "'Sausage' swelling of a whole finger or toe â€” very typical of psoriatic and reactive arthritis.",
    body:
  ...
  "morning-stiffness": {
    ...
    short:
      "Joint stiffness on waking â€” the length of it helps tell inflammatory arthritis from osteoarthritis.",
    body:
      "Morning stiffness is stiffness in joints on first waking or after long rest. Inflammatory arthritis (rheumatoid, psoriatic, ankylosing spondylitis, polymyalgia rheumatica) typically causes prolonged stiffness of over 30â€“60 minutes that improves with movement. Osteoarthritis stiffness is usually shorter â€” less than 30 minutes â€” and tends to return after activity. Clinicians ask about duration and pattern because it is one of the most useful clues when deciding which type of arthritis is likely.",
    related: ["flare", "remission", "crepitus"],
  },
  osteophyte: {
    label: "Osteophyte",
    short:
      "A bony spur that grows around a worn joint â€” a classic osteoarthritis finding on X-ray.",
    body:
      "Osteophytes are smooth bony outgrowths that form at the edges of a joint as it remodels in response to osteoarthritis. They are the body's attempt to spread load across a worn joint, but can restrict movement or press on nerves â€” for example in the spine where they can contribute to sciatica. Osteophytes on an X-ray, together with joint-space narrowing and subchondral bone changes, are one of the classic radiographic features clinicians use to grade osteoarthritis.",
    related: ["subchondral", "cartilage", "crepitus"],
  },
  subchondral: {
    label: "Subchondral bone",
    short:
      "The layer of bone just beneath cartilage â€” where osteoarthritis changes are often first seen.",
    body:
      "The subchondral bone lies immediately under the cartilage in a joint. In osteoarthritis, as cartilage wears, load transfers to this bone; it responds by thickening (sclerosis), forming cysts and remodelling â€” all changes visible on X-ray. Painful subchondral bone-marrow lesions on MRI are increasingly recognised as a source of osteoarthritis pain and a target for research into new treatments.",
  ...
  pannus: {
    ...
    body:
      "Pannus is thickened, invasive tissue formed from an inflamed synovium in rheumatoid arthritis. It creeps over the joint's cartilage and bone and releases enzymes that erode both â€” the mechanism behind the joint deformities seen in poorly-controlled rheumatoid disease. Modern early DMARD and biologic treatment aims to stop pannus forming in the first place, which is why the UK healthcare system refers suspected rheumatoid arthritis to specialists within weeks of symptoms.",
    related: ["synovium", "dmard", "biologic"],
  },
  ankylosis: {
    label: "Ankylosis",
    short:
      "Complete stiffening of a joint as it fuses â€” the end-stage picture in advanced ankylosing spondylitis.",
    body:
