...
// UK-focused (NHS terminology where relevant). Keep entries 50–100 words.
...
export const GLOSSARY_CONTENT: Record<string, GlossaryEntry> = {
  dmard: {
    ...
    body:
      "DMARD stands for Disease-Modifying Anti-Rheumatic Drug. Unlike painkillers, DMARDs damp down the overactive immune response driving conditions like rheumatoid, psoriatic and juvenile arthritis, which slows joint damage over months. Conventional DMARDs include methotrexate, sulfasalazine, hydroxychloroquine and leflunomide — nearly always started by an NHS rheumatologist, then monitored with regular blood tests. They typically take 6–12 weeks to work. If they don't control disease activity, the team may add or switch to a biologic or targeted synthetic DMARD.",
  ...
  "hla-b27": {
    ...
    body:
      "HLA-B27 is a variant of a normal immune-system gene (human leukocyte antigen). It is much more common in people with ankylosing spondylitis, reactive arthritis, psoriatic arthritis and acute anterior uveitis, so the NHS uses a simple blood test as one piece of evidence when diagnosing spondyloarthritis. Being HLA-B27 positive does not mean you will develop disease — most carriers never do — and being negative does not rule it out. It is one clue among symptoms, examination and imaging.",
  ...
  "anti-ccp": {
    ...
    body:
      "Anti-CCP (anti-cyclic citrullinated peptide) antibodies attack proteins the body has slightly modified through a process called citrullination. They are far more specific to rheumatoid arthritis than rheumatoid factor and can appear years before joint symptoms start. A positive anti-CCP in someone with joint pain strongly points to rheumatoid arthritis and predicts a higher risk of erosive damage, so the NHS uses it early in the diagnostic workup to justify starting DMARDs quickly.",
  ...
  pannus: {
    ...
    body:
      "Pannus is thickened, invasive tissue formed from an inflamed synovium in rheumatoid arthritis. It creeps over the joint's cartilage and bone and releases enzymes that erode both — the mechanism behind the joint deformities seen in poorly-controlled rheumatoid disease. Modern early DMARD and biologic treatment aims to stop pannus forming in the first place, which is why the NHS refers suspected rheumatoid arthritis to specialists within weeks of symptoms.",
  ...
  "uric-acid": {
    ...
    body:
      "Uric acid is a normal breakdown product of purines from cells and certain foods. When blood levels stay high, needle-like urate crystals can form in joints (classically the big toe) and cause the sudden, severe pain of gout, or build into lumps under the skin (tophi). NHS treatment combines short-term flare relief (NSAIDs, colchicine or steroids) with long-term urate-lowering therapy — usually allopurinol or febuxostat — aiming for a target blood urate.",
