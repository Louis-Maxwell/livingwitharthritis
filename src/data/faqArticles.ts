...
export const faqArticles: FaqArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'How PIP is scored for arthritis symptoms', content: "PIP has two parts: daily living and mobility. An assessor scores you against ten daily living activities (preparing food, eating, managing medication and therapy, washing and bathing, managing toilet needs, dressing and undressing, communicating, reading, mixing with others, and managing money) and two mobility activities (planning and following a journey, and moving around). Eight points in a part gives the standard rate; twelve points gives the enhanced rate. Hand and wrist arthritis commonly scores under preparing food, dressing and washing — for example, needing an aid such as a jar opener, a perching stool, a long-handled sponge, a shower seat, or a button hook. Knee, hip, foot and spinal arthritis usually score under moving around, which is graded by how far you can walk: less than 20 metres, 20 to 50 metres, 50 to 200 metres, or more than 200 metres." },
      { heading: 'PIP eligibility with hand, wrist and finger arthritis', content: "Hand arthritis is assessed by task, not by grip strength or X-ray changes. The daily living activities it most often affects are preparing food (chopping and peeling), taking nutrition (holding cutlery or a full mug), managing medication (blister packs and bottle tops), washing and bathing (getting in and out, holding a sponge), managing toilet needs, dressing (buttons, zips, bra fastenings, laces) and communicating or reading if you cannot hold a phone, pen or book. Needing an aid — jar opener, kettle tipper, button hook, long-handled sponge, electric toothbrush, adapted cutlery — usually scores two points for that activity, and several two-point scores add up to the eight needed for the standard rate. Needing another person to help, rather than an aid, scores higher. Say clearly if you can manage on a good day but not during a flare, and if hand pain means a task takes far longer or has to be broken into stages." },
      { heading: 'Osteoarthritis and the PIP mobility score', content: "The moving around activity is scored purely on distance walked reliably — safely, repeatedly, in a reasonable time. Standing and then moving more than 200 metres scores zero; more than 50 but no more than 200 metres scores four points; more than 20 but no more than 50 metres scores eight points (standard rate); more than 1 but no more than 20 metres scores twelve points (enhanced rate); and being unable to stand or move more than one metre, even with an aid, scores twelve. Knee, hip, foot and spinal osteoarthritis often means a person can reach 200 metres once, then cannot repeat it that day or needs to stop and rest — that is not walking the distance reliably, so describe the pain level, the stops, the recovery time and what happens on the way back. Using a stick, crutch or scaffolding along the route is relevant and should be stated. The second mobility activity, planning and following a journey, covers anxiety, disorientation or needing someone with you, and is scored separately." },
      { heading: 'The "reliably" rule most arthritis claims turn on', content: "You only count as able to do an activity if you can do it reliably — safely, to an acceptable standard, repeatedly as often as you reasonably need to, and in a reasonable time (broadly no more than twice as long as someone without your condition). This matters enormously in arthritis, where the honest answer is often \"yes, but\". If you can climb into the bath but risk falling, if you can chop vegetables but not twice in a day, if you can walk 100 metres but only once and then need to rest for an hour, or if morning stiffness means dressing takes 45 minutes, say so in exactly those terms. Describe a bad day and a flare as well as a good day, and give the rough proportion of days each applies — the rules say an activity counts if it applies on more than half the days over a year." },

      { heading: 'Evidence that strengthens an arthritis claim', content: "Send what you already have rather than waiting for new letters: rheumatology or orthopaedic clinic letters, X-ray or MRI reports, your repeat prescription list (DMARDs, biologics, steroid injections, opioids), physiotherapy or occupational therapy notes, an OT home assessment, and any Blue Badge or aids and adaptations record. A short diary covering two weeks — how long you took to dress, how far you walked, how many days you could not cook — is often more persuasive than a GP letter, because it maps directly onto the descriptors. Keep a copy of everything you send." },
      { heading: 'Employment and Support Allowance (ESA) and Universal Credit', content: "If arthritis limits your ability to work, new-style ESA is based on your National Insurance record; otherwise the limited capability for work element of Universal Credit does the same job. Both use the Work Capability Assessment, which is a separate test from PIP with its own descriptors — you can be found fit for work and still receive PIP, and vice versa. You will need a fit note from your GP while your assessment is pending." },
      { heading: 'Other benefits and passported help', content: "Attendance Allowance is for people over State Pension age who need help with personal care and has no mobility component. Disability Living Allowance still applies to under-16s. Carer's Allowance may be claimable by someone who cares for you for 35 hours or more a week, if you get a qualifying rate of PIP daily living. A PIP award can also passport you to a Blue Badge, a disabled person's railcard or bus pass, Motability (enhanced mobility rate), council tax reductions and reduced water charges. Check these separately — they are not awarded automatically." },
      { heading: 'How to apply, step by step', content: "Start the claim by phoning the DWP PIP new claims line or applying online; the claim date is set when you first make contact, so start it before you gather paperwork. You will then be sent the PIP2 form, \"How your disability affects you\", which you normally have one month to return — ring and ask for extra time if you need it. Use the extra information box, and answer each activity in the language of the reliably rule. Most assessments are now by telephone or video, though face-to-face still happens. Free help with forms is available from Citizens Advice, your local welfare rights service, and hospital rheumatology social workers." },
