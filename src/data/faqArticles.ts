...
export const faqArticles: FaqArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Spotting Depression and Anxiety Early', content: "Warning signs include persistent low mood for more than two weeks, loss of interest in things you once enjoyed, sleep changes beyond what pain explains, social withdrawal, irritability, panic symptoms, or thoughts that life is not worth living. If any of these are present, contact your GP. NHS Talking Therapies accepts self-referral in most areas and offers CBT specifically adapted for long-term physical conditions." },
      ...
      { heading: 'When to Seek Urgent Help', content: "If you have thoughts of suicide or self-harm, contact your GP urgently, call NHS 111, or call Samaritans free on 116 123 any time, day or night. In immediate danger call 999. Asking for help is a clinical step, not a weakness — and it works." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Vitamin D', content: "Around half of UK adults are vitamin-D insufficient in winter, and low levels are linked to higher musculoskeletal pain and worse arthritis outcomes. NHS advice is to take 10 micrograms (400 IU) daily from October to March — many people with arthritis are advised to take this year-round. Have levels checked if pain is poorly controlled." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Getting Fitted Properly', content: "A 15-minute appointment with a physiotherapist or occupational therapist ensures correct height, technique and aid choice. Self-referral is available in many NHS areas. Wrong-height sticks cause shoulder, back and wrist pain — a common but preventable problem." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Insoles and Orthotics', content: "Off-the-shelf cushioned insoles (gel or foam) help most people and cost little. Custom orthotics, made after a podiatry assessment, are valuable for severe flat feet, leg-length differences, hallux rigidus or post-surgical change. NHS podiatry referrals are available via your GP." },
      { heading: 'When Custom Footwear is Needed', content: "Severe foot deformity from rheumatoid arthritis, ulcers, dropped foot or fused joints may need bespoke shoes. NHS orthotic services provide these. Bespoke shoes look more normal than they used to and dramatically extend independent walking." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'NHS vs Private Pathways', content: "NHS rheumatology waits vary; urgent referrals are usually seen within weeks. If wait times exceed NICE targets, ask your GP about referral to a neighbouring trust. Private consultation (typically £200-300) gives faster access and a written report you can share with the NHS team — many people use it to expedite diagnosis, then continue NHS treatment." },
