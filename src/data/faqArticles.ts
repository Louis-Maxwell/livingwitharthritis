/**
 * FAQ article cluster â€” 19 evidence-based answers feeding the
...
export const faqArticles: FaqArticle[] = [
  ...
  },
  {
    ...
    sections: [
      { heading: 'Personal Independence Payment (PIP)', content: "For people aged 16-64. It's not means-tested. You get money if arthritis affects your ability to move around or care for yourself. Two rates: Standard (low difficulty) or Enhanced (significant difficulty). Average payment Â£184-627/month." },
  ...
  },
  {
    ...
    quickAnswer:
      "Legally, yes â€” if it substantially limits your ability to do normal activities. This means you're protected by the Equality Act 2010.",
    sections: [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Medication Safety in Pregnancy', content: "Hydroxychloroquine, sulfasalazine, azathioprine, ciclosporin and most TNF-inhibitor biologics (especially certolizumab) have substantial safety data and can usually continue. Methotrexate, leflunomide, mycophenolate, cyclophosphamide and JAK inhibitors must be stopped before conception. NSAIDs are best avoided after 20 weeks. Low-dose prednisolone, paracetamol and short courses of opioids are generally considered safe. Never stop a DMARD without specialist advice â€” uncontrolled disease is itself a pregnancy risk." },
      { heading: 'Labour, Delivery and Pain Relief', content: "Most women can plan a vaginal delivery. Hip, knee or spine involvement may need extra positioning support â€” discuss this in advance with your midwife. Epidural anaesthesia is usually possible but a senior anaesthetic review is wise if the cervical spine, jaw or hips are affected. A short antenatal physiotherapy appointment to practise labour positions is invaluable." },
      { heading: 'The Postpartum Flare', content: "Rheumatoid arthritis flares within three to six months of delivery in roughly half of women, partly driven by falling pregnancy hormones and broken sleep. Restart maintenance DMARDs promptly â€” most are compatible with breastfeeding, including hydroxychloroquine, sulfasalazine and TNF inhibitors. Arrange extra help with lifting and night feeds, and book a rheumatology review within the first six weeks." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'The First 48 Hours: Rest, Ice, Elevate', content: "Reduce load on the affected joints â€” sit when possible, swap a long walk for pool work or none at all. Apply a wrapped ice pack for 15-20 minutes every 2-3 hours for the first day to settle acute swelling, then switch to heat for morning stiffness. Take regular pain relief as prescribed rather than waiting for pain to peak. Aim for 8-9 hours of sleep and prioritise hydration." },
      { heading: '48-72 Hour Protocol', content: "Begin gentle range-of-motion movement every couple of hours â€” even five slow circles or stretches stops joints stiffening. Eat anti-inflammatory meals (oily fish, leafy greens, berries, olive oil) and avoid alcohol. Use splints only briefly to rest very painful hands or wrists; prolonged immobilisation weakens muscle and worsens recovery. Cancel non-essential commitments without guilt â€” recovery is the priority." },
      { heading: 'When to Contact Your GP or Rheumatology Team', content: "Call within 24 hours if you develop a fever above 38Â°C, a new hot swollen joint that could indicate infection, chest pain, breathlessness, a new rash, or if symptoms are not improving after 72 hours of self-care. Septic arthritis is an emergency. If you are on biologics or DMARDs, your rheumatology helpline can often adjust medication or arrange a steroid injection or short oral steroid course." },
      { heading: 'Activity Pacing and the Return to Normal', content: "Reintroduce activity at 50% of your pre-flare baseline and add roughly 10% per day. Use the 'two-day rule' â€” if pain is worse two days after an activity, the dose was too high. Our best exercises for arthritis guide includes gentle resumption plans for knees, hips and hands." },
      { heading: 'Preventing the Next Flare', content: "After every flare, review what came before it and pick one change for next time â€” earlier medication, better sleep, more hydration, or saying no to one extra commitment. Long-term, consistent low-impact exercise, anti-inflammatory eating, stress management and never skipping DMARDs cut flare frequency by 30-50% in most studies." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Treatments That Work', content: "Cognitive behavioural therapy, acceptance and commitment therapy, mindfulness-based stress reduction and graded activity scheduling all have strong evidence in arthritis populations. Antidepressants â€” particularly duloxetine â€” can reduce both mood symptoms and pain. Treatment usually combines therapy, lifestyle change and, where needed, medication. None of these are 'soft options' â€” they produce measurable changes in inflammatory markers as well as mood." },
      { heading: 'Movement as Antidepressant', content: "Regular low-impact exercise produces antidepressant effects comparable to mild-to-moderate medication. Pool exercise, walking, yoga and tai chi all qualify. The dose that helps mood is lower than the dose that builds fitness â€” 20-30 minutes most days is enough. Our best exercises for arthritis guide has safe starting points for stiff or painful joints." },
      { heading: 'Connection Beats Isolation', content: "Loneliness amplifies pain and slows recovery. Peer support â€” whether a local group, an online forum or a single trusted friend who 'gets it' â€” lowers depression scores within weeks. Telling one person about a bad day breaks the spiral. Read our full arthritis mental health hub for support directories and self-help tools." },
      { heading: 'When to Seek Urgent Help', content: "If you have thoughts of suicide or self-harm, contact your GP urgently, call 999 or 112, or call Samaritans free on 116 123 any time, day or night. In immediate danger call 999. Asking for help is a clinical step, not a weakness â€” and it works." },
    ],
  ...
  },
  {
    ...
    sections: [
      { heading: 'Pain Relief', content: 'Paracetamol (safe, mild), NSAIDs (ibuprofen, naproxen â€” stronger but side effects), opioids (strong, for severe pain). Start lowest effective dose.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Practical Strategies', content: '15. Work with your doctor. 16. Use aids and equipment. 17. Plan ahead for activities. 18. Communicate your needs. 19. Celebrate small wins. 20. Remember: arthritis is a journey â€” adjustments happen gradually.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Blood Vessels and Muscles in the Cold', content: "Cold causes peripheral blood vessels to constrict, reducing oxygen delivery to muscles around the joint. Muscles tighten reflexively to conserve heat, pulling on already-sensitive structures. People with Raynaud's â€” common alongside lupus, scleroderma and rheumatoid arthritis â€” feel this most sharply in fingers and toes." },
      { heading: 'The Hidden Trigger: Inactivity', content: "Most people simply move less in winter. Daily step counts can drop by 30-40% between July and January in the UK. Reduced movement means stiffer joints, weaker supporting muscles and lower mood â€” a triple hit that explains a large portion of 'winter arthritis'." },
      { heading: 'Five Practical Cold-Weather Strategies', content: "1. Layer up â€” thermal base layers, fingerless gloves indoors, heated insoles. 2. Warm the joint before activity with a hot shower, wheat bag or paraffin wax bath for hands. 3. Keep moving indoors â€” chair-based exercise, stairs, or a 10-minute walk after every meal. 4. Eat warm anti-inflammatory meals â€” soups, stews, oily fish, ginger and turmeric. 5. Top up vitamin D between October and March, as low levels worsen musculoskeletal pain." },
      { heading: 'When Winter Pain is Something More', content: "If a single joint becomes hot, red and very swollen, or if you develop fever, chest pain or breathlessness, do not blame the weather â€” contact your GP urgently. Sudden severe winter joint pain can occasionally indicate gout, infection or a new inflammatory diagnosis." },
    ],
  ...
  },
  {
    ...
    quickAnswer:
      'Topical NSAIDs, capsaicin and menthol-based rubs all have evidence in arthritis â€” they work locally with far fewer side effects than tablets.',
    sections: [
  ...
  },
  {
    ...
    quickAnswer:
      'The biggest myths â€” that exercise wears joints out, that rest is best, and that pain means damage â€” are wrong. Movement is one of the most effective arthritis treatments.',
    sections: [
      { heading: "Myth 1: 'Exercise Wears Joints Out'", content: "Cartilage is living tissue and depends on movement for nutrition â€” joint fluid is squeezed in and out like a sponge with every step. Decades of research, including long-term running studies, show that regular low-impact exercise does not cause or worsen osteoarthritis. It is inactivity, not activity, that accelerates joint degeneration." },
      ...
      { heading: 'What the Evidence Actually Recommends', content: "150 minutes of moderate aerobic activity per week, two strength sessions and daily flexibility work â€” the same prescription as for the general population, adapted to your joints. Our best exercises for arthritis guide gives a starter plan for every joint." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'School, Work and Identity', content: "Young people with arthritis face unique challenges: missed school, visible joint swelling, restrictions in sport, and the social weight of looking 'fine' while feeling exhausted. Reasonable adjustments for exams, university and early career are available. Read our mental health guide â€” psychological support should be part of every young person's care plan." },
  ...
  },
  {
    ...
    quickAnswer:
      'Yes. Losing 5-10% of body weight typically reduces knee pain by 20-50% and lowers systemic inflammation â€” one of the most effective non-drug treatments available.',
    sections: [
      ...
      { heading: 'The 5-10% Threshold', content: "Trial evidence consistently shows that losing 5% of body weight gives measurable benefit, 10% gives substantial benefit, and combining weight loss with exercise is more effective than either alone. For an 85 kg person that is 4-8 kg â€” an achievable target over six to twelve months." },
      { heading: 'What to Eat', content: "Mediterranean-style eating â€” vegetables, legumes, whole grains, oily fish, nuts, olive oil, modest dairy, minimal ultra-processed food â€” produces sustainable loss without calorie counting and reduces inflammation independently. Our arthritis nutrition guide and foods to avoid page have practical meal templates. Crash diets fail and accelerate muscle loss." },
      ...
      { heading: 'Sleep, Stress and Sustainable Habits', content: "Poor sleep raises ghrelin (hunger hormone) and lowers leptin (fullness hormone), making weight loss harder. Stress drives emotional eating. Address both alongside diet â€” they are not separate problems." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Getting a Professional Assessment', content: "Driving Mobility centres across the UK offer free or low-cost assessments by occupational therapists and driving instructors. They can recommend adaptations, trial vehicles and provide a formal report â€” useful evidence for Access to Work, Motability or DVLA discussions. Self-referral is allowed." },
      { heading: 'When Driving is No Longer Safe', content: "Warning signs include difficulty turning the head to check blind spots, slow reaction time, severe morning stiffness, or pain that distracts you. You must notify the DVLA of any condition that affects safe driving. Stopping driving is a major life adjustment â€” explore taxis, community transport, Motability schemes and family support before isolation sets in." },
    ],
  ...
  },
  {
    ...
    sections: [
      { heading: 'Why Position Matters', content: "Joints held in awkward positions for hours overnight stiffen and inflame. Choosing a posture that keeps the spine neutral and unloads inflamed joints can reduce morning pain by 30-40% without any medication change. Small props â€” a rolled towel, an extra pillow â€” often make a bigger difference than a new mattress." },
      { heading: 'Side-Lying â€” The All-Rounder', content: "Lie on the less painful side with knees slightly bent and a firm pillow between them to keep hips, pelvis and lumbar spine in line. Hug a second pillow with your top arm to support a painful shoulder. This position suits most hip, knee and lower-back arthritis." },
      ...
      { heading: 'Positions to Avoid', content: "Front-lying forces the neck into 90Â° rotation for hours and over-extends the lumbar spine â€” it is the worst position for neck, back, hip and shoulder arthritis. If you cannot break the habit, try a thin pillow under the pelvis to reduce lumbar arch." },
      ...
      { heading: 'Temperature, Bedding and Pre-Sleep Routine', content: "Cold joints stiffen overnight. A warm bath 60-90 minutes before bed, a heated mattress topper on a low setting, or a hot-water bottle on a sore joint all help. Keep the bedroom around 18Â°C with breathable bedding. Take any night-time analgesia 30 minutes before lying down so it peaks as you settle." },
      { heading: 'When to Get Help', content: "If pain wakes you more than three nights a week despite these changes, see your GP â€” uncontrolled night pain often signals that disease activity, medication or mood needs review. See our arthritis and sleep guide for more." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Warm Up First', content: "Always warm the hands first â€” five minutes in warm water, with a wheat bag, or with a paraffin wax bath. Cold stiff joints are more likely to flare during exercise. Apply a topical NSAID 30 minutes beforehand if recommended by your GP." },
      ...
      { heading: 'Strengthening', content: "Squeeze a soft therapy ball or piece of putty for three seconds, release, repeat ten times. Progress to a firmer putty as comfort allows. Pinch putty between thumb and each finger in turn. Avoid heavy gripping during a flare â€” light putty is enough." },
      ...
      { heading: 'How Often and How Much', content: "Aim for one or two short sessions a day, every day. Consistency beats intensity. If pain is worse 24 hours later, reduce the resistance or repetitions â€” never push through sharp pain. A hand therapist can tailor a programme to your specific joints." },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Who Gets Each Condition', content: "OA most commonly affects people over 50, often after a previous joint injury or in those carrying extra weight. RA can begin at any age â€” peak onset is 30-60 â€” affects women three times more often than men, and may follow infections, smoking or significant stress in genetically susceptible people." },
      { heading: 'Symptom Patterns', content: "OA pain is typically worse with activity and eases with rest; morning stiffness lasts under 30 minutes. It usually affects a few joints â€” most often knees, hips, hands and lower back â€” and is not symmetrical. RA causes prolonged morning stiffness over an hour, fatigue, low-grade fever and symmetrical swelling of small joints (knuckles, wrists, feet). Pain often eases with gentle activity." },
      ...
      { heading: 'Treatment Paths', content: "OA treatment focuses on weight loss, exercise, topical NSAIDs, occasional injections and ultimately joint replacement when function is lost. RA requires disease-modifying drugs (DMARDs) and often biologics to suppress the immune attack â€” early aggressive treatment prevents joint damage. Both benefit hugely from exercise, anti-inflammatory eating and mental-health support." },
      { heading: 'Outlook', content: "OA progresses slowly over years; modern joint replacements give excellent function. RA, treated early, often reaches remission and most patients live full active lives. Untreated RA causes irreversible joint damage within months â€” early diagnosis is everything." },
  ...
  },
  {
    ...
    sections: [
      { heading: 'The Mediterranean Pattern Wins', content: "Of all the diets studied in arthritis, the Mediterranean pattern has the most consistent evidence. It reduces inflammatory markers, lowers pain scores, supports weight loss and improves cardiovascular health â€” important because RA itself raises heart-disease risk. The pattern is built on vegetables, legumes, whole grains, oily fish, nuts, olive oil and modest dairy, with minimal ultra-processed food." },
      { heading: 'Omega-3 Fatty Acids', content: "EPA and DHA from oily fish â€” salmon, mackerel, sardines, herring, anchovies â€” reduce inflammatory prostaglandins. Aim for two portions a week, or consider a 1-2 g daily fish-oil supplement if you do not eat fish. Plant sources (flaxseed, walnuts, chia) provide ALA, which converts only modestly to EPA but still adds anti-inflammatory value." },
      { heading: 'Vitamin D', content: "Around half of UK adults are vitamin-D insufficient in winter, and low levels are linked to higher musculoskeletal pain and worse arthritis outcomes. UK healthcare advice is to take 10 micrograms (400 IU) daily from October to March â€” many people with arthritis are advised to take this year-round. Have levels checked if pain is poorly controlled." },
      ...
      { heading: 'Protein and Muscle', content: "Chronic inflammation accelerates muscle loss. Spread 20-30 g of protein across each main meal â€” eggs, fish, poultry, dairy, legumes, tofu â€” to support the muscle that protects your joints. Older adults often need more, around 1.0-1.2 g per kg body weight daily." },
  ...
  },
  {
    ...
    quickAnswer:
      'Use a walking aid as soon as it lets you walk further, more confidently and with less pain â€” it preserves independence rather than reducing it.',
    sections: [
      ...
      { heading: 'Walking Frames and Rollators', content: "A standard Zimmer frame suits indoor use when balance is poor. A wheeled rollator with brakes and a seat is the better choice for outdoor walking â€” it allows a natural gait, carries shopping, and provides a rest stop. Three-wheel rollators are lighter; four-wheel models more stable." },
      { heading: 'Getting Fitted Properly', content: "A 15-minute appointment with a physiotherapist or occupational therapist ensures correct height, technique and aid choice. Self-referral is available in many UK healthcare areas. Wrong-height sticks cause shoulder, back and wrist pain â€” a common but preventable problem." },
      { heading: 'The Psychological Step', content: "Using an aid in public can feel like a public admission of disability. Most people report that within a few weeks the freedom it brings â€” longer walks, less fear of falling, more energy at the destination â€” outweighs the self-consciousness. A folding stick that lives in a bag is often a useful starter step." },
      { heading: 'When You Need More Than a Stick', content: "If you are falling, struggling on stairs or limited indoors, ask your GP about a community OT assessment. Stairlifts, grab rails, perching stools and powered mobility scooters all sit on the same spectrum â€” tools that protect independence." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Pacing Through the Day', content: "Use the 'movement minute' rule â€” stand, stretch and walk for one minute every 30. Schedule the hardest task for the time of day your joints work best. Take your full lunch break away from the desk. Plan recovery evenings in the first fortnight â€” no commitments after work." },
      ...
      { heading: 'Reasonable Adjustments â€” Your Legal Right', content: "Under the Equality Act 2010 your employer must make reasonable adjustments. See our employment rights guide for full detail. Requests should be in writing and confirmed in writing â€” useful evidence if problems arise later." },
  ...
  },
  {
    ...
    quickAnswer:
      "A wide toe box, cushioned sole, rigid mid-foot, low heel and secure fastening cut foot, knee, hip and back pain in arthritis â€” far more than any 'orthopaedic' label.",
    sections: [
      ...
      { heading: 'The Five Features to Look For', content: "1. Wide rounded toe box â€” no pressure on bunions or swollen toe joints. 2. Cushioned sole, especially under the heel and ball of the foot. 3. Firm mid-foot ('twist test' â€” the shoe should resist twisting). 4. Heel height under 3 cm. 5. Laces, velcro or buckles for secure fit â€” never slip-on shoes that force the toes to grip." },
      { heading: 'Trainers Are Often the Best Choice', content: "Modern cushioned running and walking trainers tick most arthritis boxes. Look for 'stability' or 'motion control' models rather than minimalist or racing flats. Replace every 600-800 km or 12 months â€” the cushioning compresses long before the upper wears out." },
      ...
      { heading: 'A Quick Test', content: "Pick up the shoe. Twist the sole â€” it should bend at the toes, not in the middle. Bend the toe upwards â€” it should hinge near the ball of the foot, not in the arch. Press the heel area â€” it should feel cushioned. If a shoe passes all three, it is probably arthritis-friendly." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Pacing on Holiday', content: "Plan one main activity per day, not three. Build in rest mornings or afternoons. Use taxis or public transport rather than walking everything. A holiday is not the time to push through pain â€” recovery time on return is often much longer than the trip itself." },
      { heading: 'If You Flare Away From Home', content: "Most pharmacists abroad can help with simple pain relief. The GHIC (replaces EHIC) covers state healthcare in EU countries. For serious flares, contact your travel insurer's 24-hour line first â€” they will guide you to an approved clinic and authorise costs." },
    ],
  ...
  },
  {
    ...
    quickAnswer:
      'Ask for urgent referral if you have joint swelling lasting more than six weeks, morning stiffness over an hour, or multiple symmetrical joints affected â€” early specialist review prevents permanent damage.',
    sections: [
      ...
      { heading: 'After the Appointment', content: "Most rheumatology services provide a nurse-led helpline for flares, medication queries and urgent advice â€” use it. Read our arthritis medication guide so you understand what is being prescribed. Treatment works best when you are an informed partner in your care." },
    ],
