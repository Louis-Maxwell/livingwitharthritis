/**
 * AEO/GEO page data â€” answer-first summaries, FAQs, review metadata for
...
export const PAGE_AEO: Record<string, AeoPage> = {
  ...
  "/conditions/osteoarthritis": withDefaults({
    ...
    faqs: [
      ...
      { q: "Does osteoarthritis show on an X-ray?", a: "Yes â€” X-rays show joint space narrowing and bone spurs, though symptoms don't always match imaging severity." },
  ...
  "/conditions/psoriatic-arthritis": withDefaults({
    ...
    answer:
      "Psoriatic arthritis (PsA) is an inflammatory arthritis that affects around 1 in 5 people with psoriasis. It causes joint pain, swelling and stiffness â€” often in fingers, toes, lower back or knees â€” plus nail changes and skin plaques. Early diagnosis and DMARDs or biologics prevent joint damage.",
    faqs: [
  ...
  "/conditions/ankylosing-spondylitis": withDefaults({
    ...
    faqs: [
      ...
      { q: "What is the HLA-B27 test?", a: "A blood test that checks for the HLA-B27 gene, found in around 90% of UK people with AS. A positive test alone doesn't diagnose AS â€” it's used alongside symptoms and MRI scans." },
      { q: "Should I exercise if my back hurts?", a: "Yes â€” gentle, regular movement is the single most important treatment for AS. Pain that eases with activity is typical. A physiotherapist can build a safe, progressive programme." },
    ],
  }),
  "/conditions/gout": withDefaults({
    question: "What is gout?",
    answer:
      "Gout is a type of inflammatory arthritis caused by high uric acid crystallising inside joints â€” usually the big toe â€” triggering sudden severe pain, redness and swelling. UK guidelines recommend urate-lowering therapy (allopurinol) after a second attack to prevent joint damage. Diet and alcohol adjustments help.",
  
    faqs: [
      { q: "What are the first signs of gout?", a: "The first sign is usually a sudden, severe attack of pain in a single joint â€” most often the big toe â€” that wakes you up at night. The joint becomes red, hot, swollen and so tender that even the weight of a bedsheet feels unbearable. Attacks typically peak within 24 hours." },
      { q: "How do I know if my toe pain is gout?", a: "Gout in the big toe (called podagra) comes on suddenly, usually overnight, with intense burning pain, redness, heat and swelling at the base of the toe. If you can't bear weight on it or even touch it, and the attack settles over 3â€“10 days, gout is the most likely cause. A blood test for uric acid and joint fluid analysis can confirm it." },
      { q: "What does a gout attack feel like?", a: "Most people describe a sudden, intense burning or throbbing pain in one joint â€” often the big toe â€” that starts overnight. The joint becomes red, hot, swollen and so tender that even a bedsheet can be unbearable." },
  ...
  "/conditions/fibromyalgia": withDefaults({
    ...
    faqs: [
      ...
      { q: "How is fibromyalgia diagnosed in the UK?", a: "Diagnosis is clinical â€” based on widespread pain lasting over 3 months, plus fatigue, sleep and cognitive symptoms. Blood tests are used to rule out other conditions." },
      { q: "What is fibro fog?", a: "Fibro fog is the cognitive symptom of fibromyalgia â€” short-term memory lapses, word-finding difficulties and trouble concentrating. It improves with better sleep, pacing and exercise." },
      ...
      { q: "Does fibromyalgia get worse over time?", a: "Fibromyalgia is not progressive â€” it doesn't damage tissue. Symptoms fluctuate, often worsening with stress, poor sleep or overdoing activity, and easing with steady self-management." },
    ],
  }),
  "/conditions/lupus": withDefaults({
    ...
    faqs: [
      ...
      { q: "Can lupus be cured?", a: "There is no cure, but modern treatments â€” particularly hydroxychloroquine â€” control symptoms and reduce flares for most people. Many achieve long periods of remission." },
      ...
      { q: "Why is sun protection so important with lupus?", a: "UV light can trigger lupus flares â€” both skin rashes and internal symptoms. Daily SPF 50, UV-protective clothing and hats are essential, even on cloudy UK days." },
  ...
  "/conditions/knee-arthritis": withDefaults({
    ...
    answer:
      "Knee arthritis is joint damage in the knee â€” most often osteoarthritis â€” causing pain when standing, walking or climbing stairs, stiffness after rest, and swelling. NICE recommends exercise and weight loss as first-line treatment; every 5 kg lost cuts knee load by roughly 20 kg.",
    faqs: [
      ...
      { q: "Should I use a walking stick?", a: "Use it in the opposite hand to the painful knee â€” this reduces load by up to 25%." },
    ],
  }),
  "/conditions/hip-arthritis": withDefaults({
    question: "What is hip arthritis?",
    answer:
      "Hip arthritis is joint damage â€” usually osteoarthritis â€” of the hip, causing groin or buttock pain, stiffness and difficulty putting on socks or shoes. Physio-led strengthening, weight management and, when severe, hip replacement (over 100,000 done in the UK each year) provide long-term relief.",
  ...
  "/conditions/hand-arthritis": withDefaults({
    ...
    faqs: [
      ...
      { q: "Do hand splints actually help?", a: "Yes â€” for thumb base (CMC) arthritis, a custom or off-the-shelf neoprene splint reduces pain during pinching tasks and is recommended by NICE as part of first-line care." },
      { q: "Are the bony lumps on my fingers permanent?", a: "Heberden's and Bouchard's nodes are bone changes and don't shrink, but the pain associated with their formation usually settles within 1â€“2 years. The remaining stiffness can be managed with exercise." },
  ...
  "/conditions/shoulder-arthritis": withDefaults({
    ...
    faqs: [
      ...
      { q: "Is shoulder arthritis the same as a frozen shoulder?", a: "No. Frozen shoulder (adhesive capsulitis) is inflammation of the joint capsule and usually resolves within 1â€“3 years. Shoulder arthritis is cartilage wear and is progressive â€” but both can cause similar early symptoms, so accurate diagnosis matters." },
      ...
      { q: "Should I get an injection in my shoulder?", a: "Corticosteroid injections can give 6â€“12 weeks of meaningful pain relief and are useful to bridge a flare or to allow physiotherapy to progress. Most clinicians limit injections to 2â€“3 per year." },
  ...
  "/conditions/elbow-arthritis": withDefaults({
    ...
    faqs: [
      ...
      { q: "What is the best exercise for elbow arthritis?", a: "Gentle range-of-motion work â€” bending and straightening the elbow within a pain-free range, plus forearm rotations (palm up, palm down) â€” is the most evidence-supported routine. Light isometric grip work protects forearm strength without loading the joint." },
      { q: "Should I see a GP about elbow pain?", a: "See your GP if elbow pain lasts more than six weeks, wakes you at night, locks or catches, or is accompanied by tingling into the ring and little fingers â€” that pattern can indicate ulnar nerve irritation that benefits from early treatment." },
  ...
  "/conditions/juvenile-arthritis": withDefaults({
    ...
    faqs: [
      ...
      { q: "Will my child grow out of JIA?", a: "Some children â€” particularly those with oligoarticular JIA â€” do go into long-term remission. Others have ongoing disease into adulthood. Modern treatments have transformed the outlook for most." },
      ...
      { q: "Can my child still play sport?", a: "Yes â€” sport is encouraged. Swimming and cycling are particularly good. Adapt during flares and work with the rheumatology team and PE staff." },
    ],
  }),
  "/conditions/reactive-arthritis": withDefaults({
    question: "What is reactive arthritis?",
    answer:
      "Reactive arthritis is joint inflammation that develops after an infection elsewhere in the body â€” usually gut or urinary. Symptoms include joint pain, eye inflammation and urinary symptoms. Most cases resolve within 3-12 months.",
    ...
    faqs: [
      ...
      { q: "Is reactive arthritis curable?", a: "Yes â€” for most people reactive arthritis settles completely once the triggering infection clears and inflammation is treated. NSAIDs, joint injections and physiotherapy speed recovery." },
      ...
      { q: "Is reactive arthritis contagious?", a: "No. Reactive arthritis itself cannot be passed from person to person. However, the infections that trigger it (such as chlamydia or salmonella) can be â€” so treating partners and practising good food hygiene matters." },
  ...
  "/conditions/polymyalgia-rheumatica": withDefaults({
    ...
    faqs: [
      ...
      { q: "Is polymyalgia rheumatica an autoimmune disease?", a: "Yes â€” PMR is driven by an overactive immune response that inflames the lining of joints and bursae, particularly in the shoulders and hips. It is not contagious and is not caused by anything you have done." },
      ...
      { q: "Are there natural alternatives to steroids for PMR?", a: "There is no proven natural alternative to steroids for PMR â€” untreated inflammation can damage tissue and increase the risk of GCA. A Mediterranean diet, exercise and bone-protection medicines support steroid treatment rather than replace it." },
    ],
  }),
  ...
  "/guides/newly-diagnosed": withDefaults({
    question: "I've just been diagnosed with arthritis â€” what should I do?",
    answer:
  ...
  "/guides/can-exercise-make-osteoarthritis-worse": withDefaults({
    ...
    answer:
      "No â€” done correctly, exercise reduces OA pain and slows progression. Some soreness during and up to 2 hours after exercise is normal. Sharp, sudden or persistent pain lasting more than 24 hours means you've done too much; scale back but don't stop.",
  }),
  ...
  "/diet-hub": withDefaults({
    ...
    answer:
      "A Mediterranean diet â€” oily fish twice a week, olive oil, nuts, wholegrains, plenty of vegetables and fruit â€” consistently reduces inflammation markers and joint pain in trials. Cut ultra-processed foods, sugary drinks and excess red meat. Weight loss of 5-10% substantially reduces knee OA pain.",
  }),
  "/exercise-hub": withDefaults({
    question: "What's the best exercise for arthritis?",
    answer:
      "Combine aerobic (walking, swimming, cycling) with strength training 2-3 times a week and flexibility work. NICE guideline NG226 recommends exercise as first-line for all arthritis types â€” with pain reduction comparable to NSAIDs and no side effects.",
  }),
};
