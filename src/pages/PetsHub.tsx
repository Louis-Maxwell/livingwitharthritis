            ...
            {shown.map((a) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h2 className="font-bold text-xl mt-1 mb-2 group-hover:text-primary transition">
                    {a.title}
                  </h2>
        ...
        <section className="bg-gray-50 px-6 py-12">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link to="/guides/heat-vs-cold-arthritis-pain" className="px-5 py-2.5 rounded-lg border border-gray-300 font-semibold hover:border-primary">
