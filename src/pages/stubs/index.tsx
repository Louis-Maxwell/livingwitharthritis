...
const DRUG_GUIDE_FAQS: StubPageFAQ[] = [
  ...
  { q: "Are NSAIDs safe to take long-term?", a: "NSAIDs can cause stomach, kidney and cardiovascular side effects when used for prolonged periods or at high doses. Use the lowest effective dose for the shortest time and review with your prescriber every 3â€“6 months." },
  { q: "What is a DMARD?", a: "A disease-modifying anti-rheumatic drug suppresses the underlying inflammatory process in rheumatoid, psoriatic, and other inflammatory arthritides â€” slowing or stopping joint damage rather than only treating pain." },
  { q: "How long do arthritis medications take to work?", a: "Paracetamol and NSAIDs work within hours. Steroid injections work within days. DMARDs and biologics typically take 6â€“12 weeks to reach full effect, which is why bridging therapy is often prescribed at the start." },
  ...
  { q: "What if my medication isn't working?", a: "Speak to your rheumatology team â€” they may adjust the dose, swap to another agent in the same class, or step you up to a biologic. Don't stop suddenly without advice, especially with steroids or DMARDs." },
];
...
export const DrugGuideStub = () => (
  <StubPage
    ...
    description="What each arthritis medication does, how long it takes to work, common side effects, and what to ask your prescriber â€” covering NSAIDs, DMARDs and biologics."
    answer="Arthritis treatment usually combines pain-relief medication (paracetamol, NSAIDs) with disease-modifying drugs (DMARDs, biologics) for inflammatory types. Most DMARDs take 6â€“12 weeks to reach full effect, so steroids are often used as a bridge. Always review medications with your prescriber every few months."
...
const SURGERY_FAQS: StubPageFAQ[] = [
  ...
  { q: "How long does recovery take?", a: "Most people are walking with crutches within days of hip or knee replacement, drive at 6 weeks, and reach near-full function by 3â€“6 months. Full recovery and final outcome are typically judged at 12 months." },
  { q: "How long do joint replacements last?", a: "Modern hip and knee replacements last 15â€“25 years for most patients, with around 80â€“90% still functioning well at 20 years. Younger and more active patients may need revision surgery later in life." },
  ...
  { q: "What can I do before surgery to improve outcomes?", a: "Strengthen the muscles around the joint (\"prehab\"), reach a healthy weight, stop smoking, optimise diabetes and blood pressure, and address any dental or skin infections â€” all reduce complications and speed recovery." },
];
...
export const SurgeryStub = () => (
  <StubPage
    ...
    description="Plain-English guide to surgery for arthritis â€” when it's considered, what to expect from hip and knee replacement, recovery times, risks, and how to prepare."
    answer="Surgery for arthritis is usually considered after months of conservative treatment fail to control severe pain or disability. Joint replacement (most often hip or knee) is the most common operation and gives excellent results for the majority of people, with implants lasting 15â€“25 years."
...
const COMPLEMENTARY_FAQS: StubPageFAQ[] = [
  { q: "Do complementary therapies work for arthritis?", a: "Evidence is strongest for acupuncture (knee OA), tai chi (knee OA, balance), yoga (general arthritis), and certain supplements (omega-3, turmeric/curcumin). They work best alongside â€” not instead of â€” conventional treatment." },
  { q: "Is acupuncture worth trying?", a: "Multiple trials show modest short-term pain relief for knee osteoarthritis. A typical course is 6â€“10 sessions. Look for a practitioner registered with the British Acupuncture Council." },
  { q: "What about CBD for arthritis pain?", a: "Evidence in humans is limited and inconsistent. If you try a CBD product, choose a UK-regulated isolate, start at the lowest dose, and tell your prescriber â€” CBD interacts with several arthritis medications." },
  { q: "Is hydrotherapy useful?", a: "Yes â€” warm-water exercise reduces joint load and is one of the best-evidenced therapies for pain and function in OA and inflammatory arthritis. Many leisure centres offer arthritis-friendly classes." },
  ...
  { q: "Are TENS machines effective?", a: "TENS provides short-term pain relief for some people, especially with knee OA. They're cheap, non-invasive, and worth a trial â€” but should sit alongside exercise and medication, not replace them." },
];
...
export const ComplementaryTherapiesStub = () => (
  <StubPage
    ...
    description="Evidence-based overview of acupuncture, tai chi, yoga, hydrotherapy, massage, TENS and supplements â€” what works, what's safe, and what to expect."
    answer="Several complementary therapies have credible evidence for arthritis: acupuncture and tai chi for knee osteoarthritis, hydrotherapy for inflammatory arthritis, and omega-3 and turmeric supplements for symptom relief. They work best alongside â€” not instead of â€” medication and exercise."
...
const INSURANCE_FAQS: StubPageFAQ[] = [
  { q: "Is arthritis care free in the UK?", a: "Most arthritis care in the UK â€” GP appointments, rheumatology, prescribed medications (with standard prescription charges in England), surgery, physiotherapy and occupational therapy â€” is provided free at the point of use through public healthcare." },
  { q: "What's the typical wait for rheumatology?", a: "Routine rheumatology referrals are usually seen within 12â€“18 weeks. Suspected inflammatory arthritis should be seen within 6 weeks. If your symptoms worsen significantly while waiting, contact your GP â€” referrals can often be escalated." },
  ...
  { q: "Are there charity grants for arthritis equipment?", a: "Yes â€” several UK charities provide small grants for mobility aids, home adaptations and respite breaks. Eligibility varies; your occupational therapist or GP can signpost appropriate funds." },
];
...
const WORK_FAQS: StubPageFAQ[] = [
  { q: "Do I have to tell my employer I have arthritis?", a: "Legally, no â€” unless your condition affects safety-critical duties. Disclosing protects you under the Equality Act 2010 and opens the door to reasonable adjustments, but the choice and timing are yours." },
  ...
  { q: "Can I claim Access to Work?", a: "Yes â€” Access to Work is a government scheme that pays for equipment, support workers, travel costs and mental health support if arthritis affects how you do your job. Apply online before starting a new role, or any time in your current job." },
  { q: "What if my job is too physical?", a: "Talk to your occupational health team if your employer has one, or your GP. Vocational rehabilitation, retraining, or a job role review may all be options. Don't soldier on silently â€” early adjustments prevent long-term harm." },
...
const TRAVEL_FAQS: StubPageFAQ[] = [
  ...
  { q: "Can I take my medication abroad?", a: "Yes â€” keep medication in original labelled packaging and carry a letter from your GP listing each drug. Some controlled medications (strong painkillers) need a personal licence for trips over 3 months. Check destination rules before travel." },
  { q: "How do I manage pain on a long journey?", a: "Stand and stretch every 60â€“90 minutes, use a small lumbar cushion, pack a heat pad or hot-water bottle, take regular pain relief on schedule rather than waiting for pain, and use the airport's special-assistance service for transfers." },
  { q: "Are warm climates better for arthritis?", a: "Many people report less pain in warm, dry weather, though research evidence is mixed. Cold, damp conditions can worsen stiffness for some. There's no single 'best' climate â€” try short trips before committing to a major move." },
  { q: "Can I get a Blue Badge for travel?", a: "Yes â€” if arthritis severely affects walking, you may qualify for a Blue Badge that allows parking close to amenities. Apply through your local council; criteria include receiving certain PIP rates or a mobility assessment." },
];
...
export const TravelStub = () => (
  <StubPage
    ...
    description="How to fly, drive and explore comfortably with arthritis â€” flight planning, travel insurance, taking medication abroad, in-journey pain control, and Blue Badge advice."
...
const FIND_SPECIALIST_FAQS: StubPageFAQ[] = [
  { q: "How do I find a rheumatologist in the UK?", a: "Ask your GP for a referral â€” this routes you into a local UK healthcare rheumatology service. For private appointments, the Royal College of Physicians and the British Society for Rheumatology both publish member directories you can search by region." },
  ...
  { q: "Do I need a referral for physio?", a: "Not for self-pay private physiotherapy â€” you can book directly. For UK healthcare physio in most areas you need a GP referral, though some regions offer self-referral. Check your local musculoskeletal service's website." },
  ...
  { q: "Are private clinics worth it?", a: "Private appointments are faster (often days vs weeks) and longer (30â€“60 mins vs 10â€“15). They're useful for second opinions, fast injections, or detailed assessments â€” but ongoing arthritis care is usually best continued through your registered UK healthcare team." },
...
export const FindSpecialistStub = () => (
  <StubPage
    ...
    description="How to find a rheumatologist, physiotherapist or occupational therapist in the UK â€” official registers, GP referrals, self-referral routes and what to expect from each."
...
const CONNECT_GROUPS_FAQS: StubPageFAQ[] = [
  { q: "What are connect groups?", a: "Connect groups are small, peer-led communities of people living with arthritis who meet regularly â€” online or in person â€” to share experiences, swap tips, and support each other through flares, treatment changes and life events." },
  { q: "Are the groups moderated?", a: "Yes â€” every group has a trained volunteer facilitator who follows our community guidelines. Medical advice is never given peer-to-peer; the facilitator signposts to appropriate clinical resources where needed." },
  ...
  { q: "Is it free?", a: "Yes â€” all groups are free to join. Donations are welcomed but never required, and no one is turned away on cost grounds." },
...
export const ConnectGroupsStub = () => (
  <StubPage
    ...
    description="Free, volunteer-led peer support groups for people with arthritis across the UK â€” meet online or in person, by condition, life stage or location."
...
const EVENTS_FAQS: StubPageFAQ[] = [
  ...
  { q: "Are events free?", a: "Yes â€” all our educational events are free. Some specialist workshops invite a voluntary donation to cover speaker costs, but this is never a condition of attendance." },
  ...
  { q: "Can my carer attend with me?", a: "Yes â€” carers, partners and family are welcome at all our community events at no extra cost." },
];
...
export const EventsStub = () => (
  <StubPage
    ...
    description="Monthly online webinars, condition Q&As, exercise demos and UK community days â€” all free, captioned, and led by clinicians and people living with arthritis."
    answer="We run monthly online webinars with clinicians and researchers, condition-specific Q&As, exercise classes and UK community days. Events are free, recorded, captioned, and open to everyone â€” including carers and family."
...
const PODCAST_FAQS: StubPageFAQ[] = [
  ...
  { q: "Can I suggest a topic?", a: "Yes â€” we'd love to hear what you want covered. Email suggestions through our contact form and we'll add them to the editorial calendar." },
...
export const PodcastsStub = () => (
  <StubPage
    ...
    description="A new UK podcast on living well with arthritis â€” practical advice, expert interviews and real-life stories, hosted by a HCPC-registered physiotherapist."
...
const HELPLINE_FAQS: StubPageFAQ[] = [
  { q: "How do I contact the helpline?", a: "Email info@livingwitharthritis.org.uk, call 07760 512 084 (Monâ€“Fri, 9amâ€“5pm), or message us on WhatsApp. A real person â€” not a chatbot â€” responds within 2 working days." },
  ...
  { q: "Can you give me medical advice?", a: "No â€” we can't diagnose, prescribe or recommend specific treatments. We can explain what your clinician has told you, suggest questions to ask, and signpost evidence-based resources." },
  { q: "How quickly will I get a reply?", a: "Email and WhatsApp: within 2 working days. Phone: within office hours, or leave a voicemail and we'll call back. Complex queries that need research may take longer â€” we'll let you know." },
  { q: "Is there a cost?", a: "No â€” all our support is free. We're funded by donations and grants, never by selling your data or by advertising." },
];
...
export const HelplineStub = () => (
  <StubPage
    ...
    description="Free UK arthritis helpline â€” email, call or WhatsApp. A real person responds within 2 working days for signposting, emotional support and help navigating services."
    answer="Our free helpline is staffed by trained people, not a chatbot. Email info@livingwitharthritis.org.uk, call 07760 512 084 (Monâ€“Fri 9â€“5), or message us on WhatsApp. We respond within 2 working days for signposting, emotional support and help understanding your diagnosis."
...
const VOLUNTEER_FAQS: StubPageFAQ[] = [
  ...
  { q: "Do I need experience?", a: "No prior experience is needed â€” only lived experience of arthritis (your own or a loved one's) and a few hours a month. We provide training, supervision and a peer-volunteer community." },
  { q: "How much time does it take?", a: "Most roles are 2â€“4 hours per month, with full flexibility around flares, treatment days and life events. We never expect a fixed schedule." },
  { q: "Will I be reimbursed for expenses?", a: "Yes â€” reasonable out-of-pocket expenses (travel, equipment, accessibility costs) are reimbursed. Volunteering should never cost you money." },
...
export const VolunteerStub = () => (
  <StubPage
    ...
    description="Flexible UK volunteer roles for people living with arthritis â€” facilitate groups, support our helpline, review content. Training provided, expenses paid, no fixed hours."
    answer="We offer flexible UK volunteer roles around lived experience: connect-group facilitators, helpline support, content reviewers, event hosts and social media volunteers. Most roles take 2â€“4 hours a month, can be done remotely, and don't affect most benefits."
...
const ADVOCACY_FAQS: StubPageFAQ[] = [
  { q: "What does advocacy mean here?", a: "Advocacy means amplifying the voices of people living with arthritis in research, service design and public conversation â€” so that what gets funded, studied and provided reflects what patients actually need." },
  ...
  { q: "Will my story be used publicly?", a: "Only with your explicit, written consent â€” and you can withdraw consent at any time. We never share names, photos or details without sign-off, and you can choose to contribute anonymously." },
  { q: "Can I influence research priorities?", a: "Yes â€” we run regular priority-setting exercises feeding into UK research funders, and patient representatives sit on several active research projects. Sign up through our contact form to express interest." },
  { q: "Do you support charity-wide campaigns?", a: "We focus on lived-experience advocacy rather than political campaigning. Where alignment exists with broader awareness work led by other neutral bodies, we may signpost â€” but we don't run political or fundraising campaigns ourselves." },
];
...
export const AdvocacyStub = () => (
  <StubPage
    ...
    description="Help shape arthritis research, services and public understanding by sharing your story, joining patient panels and contributing to consultations â€” strictly non-partisan."
    answer="Our advocacy work amplifies patient voices in research and service design â€” sharing stories, joining research panels and contributing to UK consultations. We're strictly non-partisan and never use your story without explicit, withdrawable consent."
...
const RESEARCH_FAQS: StubPageFAQ[] = [
  ...
  { q: "Can I take part in a study?", a: "Yes â€” see our clinical trials page for active UK studies recruiting people with arthritis. We highlight studies with ethical approval and clear, plain-English participant information." },
  { q: "How are research priorities decided?", a: "Through structured priority-setting partnerships with patients, clinicians and researchers â€” using established methods (e.g., the James Lind Alliance framework) to ensure patient voice drives the agenda." },
...
export const ResearchStub = () => (
  <StubPage
    ...
    description="Patient-priority arthritis research â€” seed grants, patient-and-public-involvement, UK clinical trials and transparent reporting, independent of commercial interests."
    answer="Our research work supports patient-priority studies in UK arthritis care: seed grants, patient-and-public-involvement, clinical-trials listings and dissemination. We're independent of pharmaceutical and device companies, with priorities set through structured patientâ€“clinicianâ€“researcher partnerships."
...
const TRIALS_FAQS: StubPageFAQ[] = [
  ...
  { q: "Will I receive the experimental treatment?", a: "Many trials are randomised â€” participants are assigned to the new treatment or standard care by chance. This is the most reliable way to know if a new approach works. Some trials offer the experimental treatment to all participants." },
...
export const ClinicalTrialsStub = () => (
  <StubPage
    ...
    description="Plain-English guide to UK arthritis clinical trials â€” how they work, how to find one near you, what to expect, your rights, and how trials are kept safe."
...
const GRANTS_FAQS: StubPageFAQ[] = [
  { q: "What grants do you offer?", a: "Small seed grants (typically Â£1,000â€“Â£5,000) for early-stage UK arthritis research, with a strong patient-priority and patient-and-public-involvement focus. Funding rounds open periodically â€” register for alerts to be notified." },
  ...
  { q: "Are there reporting requirements?", a: "Yes â€” funded projects submit a brief mid-point update and a plain-English final report. We share results publicly with appropriate accessibility (transcripts, summaries) so patients can benefit from what's learned." },
...
export const GrantsStub = () => (
  <StubPage
    ...
    description="UK seed grants (Â£1kâ€“Â£5k) for early-stage arthritis research with strong patient involvement â€” open to academic, clinical and patient-organisation co-applicants."
    answer="We award small seed grants (typically Â£1,000â€“Â£5,000) for early-stage UK arthritis research that includes meaningful patient-and-public-involvement. Funding rounds open periodically; lived-experience co-applicants are encouraged on every application."
