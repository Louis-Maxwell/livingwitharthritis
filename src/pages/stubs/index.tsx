...
export const InsuranceStub = () => (
  <StubPage
    ...
    description="What arthritis care costs in the UK, typical NHS waiting times, when private insurance helps (and when it doesn't), PIP claims and charity grants for equipment."
...
const FIND_SPECIALIST_FAQS: StubPageFAQ[] = [
  { q: "How do I find a rheumatologist in the UK?", a: "Ask your GP for a referral — this routes you into a local NHS rheumatology service. For private appointments, the Royal College of Physicians and the British Society for Rheumatology both publish member directories you can search by region." },
  ...
  { q: "Do I need a referral for physio?", a: "Not for self-pay private physiotherapy — you can book directly. For NHS physio in most areas you need a GP referral, though some regions offer self-referral. Check your local musculoskeletal service's website." },
  ...
  { q: "Are private clinics worth it?", a: "Private appointments are faster (often days vs weeks) and longer (30–60 mins vs 10–15). They're useful for second opinions, fast injections, or detailed assessments — but ongoing arthritis care is usually best continued through your registered NHS team." },
...
export const FindSpecialistStub = () => (
  <StubPage
    ...
    answer="UK arthritis specialists work through both NHS and private routes. Rheumatology and complex care usually require a GP referral. Physiotherapists can be seen privately without referral. Always check professional registers (GMC, HCPC) before paying, and verify NHS specialists through your local trust."
...
const TRIALS_FAQS: StubPageFAQ[] = [
  ...
  { q: "What if something goes wrong?", a: "Trials have clear safety monitoring and an independent committee that can pause or stop studies if harm is detected. You'll have a named research nurse to contact, and standard NHS care continues alongside any trial." },
];
