...
const AZA_FAQS = [
  {
    ...
    answer:
      "Azathioprine is an immunosuppressant disease-modifying drug (DMARD) used to calm an overactive immune system in inflammatory and autoimmune conditions. In arthritis care it is most often prescribed for lupus (SLE), vasculitis, severe rheumatoid arthritis that hasn't responded to first-line DMARDs, and inflammatory arthritis linked to inflammatory bowel disease. It works gradually over 8–12 weeks to reduce joint inflammation, lower flare frequency and allow steroid doses to be tapered.",
  },
  {
    question: "How long does azathioprine take to work?",
    answer:
      "Most people start to feel a reduction in joint pain, stiffness and fatigue between 8 and 12 weeks after starting treatment, with maximum benefit by 3–6 months. Because it acts slowly, it is often started alongside a short course of prednisolone (oral steroid), which controls inflammation while azathioprine builds up.",
  },
  {
...
<p>Azathioprine works slowly — most people notice improvement at 8–12 weeks and full benefit by 3–6 months — so it is usually started alongside a short course of oral steroid that controls symptoms while the DMARD builds up.</p>
...
<p>Because it suppresses immune cell turnover rather than blocking a single inflammatory signal, azathioprine is broadly active across many autoimmune conditions — but the same mechanism is why blood monitoring is essential.</p>

<h2 id="conditions">Conditions azathioprine is used for</h2>
<ul>
<li><strong>Systemic lupus erythematosus (SLE)</strong> — first- or second-line steroid-sparing agent, particularly for joint, skin and mild kidney involvement</li>
<li><strong>Vasculitis</strong> (granulomatosis with polyangiitis, microscopic polyangiitis, polyarteritis nodosa) — used for maintenance after remission is induced</li>
<li><strong>Rheumatoid arthritis</strong> — when methotrexate, sulfasalazine, hydroxychloroquine and leflunomide are unsuitable</li>
<li><strong>Inflammatory bowel disease with arthritis</strong> — treats both gut and joint disease</li>
<li><strong>Autoimmune hepatitis</strong> with joint symptoms</li>
<li><strong>Polymyositis and dermatomyositis</strong> — as a steroid-sparing agent</li>
<li><strong>Behçet's disease</strong> with arthritis or uveitis</li>
</ul>
...
<ul>
<li><strong>TPMT enzyme test</strong> — a single blood test that identifies the small number of people who break azathioprine down too slowly and are at high risk of toxicity</li>
<li><strong>Full blood count</strong> (FBC) — baseline white cells, haemoglobin and platelets</li>
<li><strong>Liver function tests</strong> (LFTs) — baseline ALT, AST and bilirubin</li>
<li><strong>Urea and electrolytes</strong> (U&amp;Es) — kidney function</li>
<li><strong>Hepatitis B, hepatitis C and HIV screen</strong> — to avoid reactivating hidden infections</li>
<li><strong>Varicella (chickenpox) immunity check</strong> — vaccination may be needed before starting</li>
<li><strong>Up-to-date pneumococcal and annual flu vaccines</strong> — give before starting where possible</li>
</ul>
...
<ul>
<li><strong>Weeks 0–6:</strong> FBC and LFTs every 1–2 weeks while the dose is being increased</li>
<li><strong>Months 2–3:</strong> every 4 weeks</li>
...
<p>Your GP will usually do the bloods under a shared-care agreement with your rheumatology team. Don't skip them, even when you feel well — they pick up bone-marrow or liver problems before you would notice symptoms.</p>
...
<li>A flu-like feeling — aches, mild fever, headache — in the first 1–2 weeks. If this is severe or persistent, contact your team; it can occasionally be a hypersensitivity reaction that means azathioprine must be stopped</li>
<li>Mouth ulcers</li>
</ul>
<h3>Less common but important</h3>
<ul>
<li><strong>Bone-marrow suppression</strong> — low white cells (raised infection risk), anaemia or low platelets (easy bruising, bleeding)</li>
<li><strong>Liver inflammation</strong> — usually picked up on routine bloods before symptoms appear</li>
<li><strong>Pancreatitis</strong> — severe upper-abdominal pain radiating to the back; needs urgent assessment</li>
<li><strong>Increased risk of infections</strong> — including shingles and chest infections</li>
<li><strong>Long-term skin-cancer risk</strong> — sun protection (SPF 50, hats, covered clothing) is important; check your skin regularly</li>
<li><strong>Small long-term increase in lymphoma risk</strong> — particularly with very long use; the absolute risk remains low and is usually outweighed by disease benefit</li>
</ul>
...
<ul>
<li><strong>Allopurinol</strong> (for gout) — the most dangerous interaction. It blocks the breakdown of azathioprine; the azathioprine dose must be reduced to about a quarter, or a different DMARD chosen. Tell every prescriber if you take both.</li>
<li><strong>Febuxostat</strong> — same problem as allopurinol; avoid the combination.</li>
<li><strong>Trimethoprim, co-trimoxazole</strong> — raise the risk of low blood counts.</li>
<li><strong>Warfarin</strong> — INR can change; more frequent monitoring is needed.</li>
<li><strong>ACE inhibitors</strong> (ramipril, lisinopril) — occasionally cause anaemia when combined.</li>
<li><strong>Live vaccines</strong> (MMR, yellow fever, nasal flu, BCG, shingles Zostavax) — avoid while on azathioprine. The non-live shingles vaccine (Shingrix), inactivated flu and pneumococcal vaccines are recommended.</li>
</ul>
...
<ul>
<li><strong>Sun protection</strong> — daily SPF 50 on exposed skin, covered clothing, hat. Have any new or changing moles checked promptly.</li>
<li><strong>Vaccinations</strong> — annual inactivated flu, pneumococcal, COVID-19 boosters and the non-live shingles vaccine (Shingrix). Avoid live vaccines.</li>
<li><strong>Infections</strong> — contact your GP early for sore throats, chesty coughs, urinary symptoms or shingles-type rashes. Don't wait it out.</li>
<li><strong>Alcohol</strong> — stay within 14 units per week; avoid binges. Stop completely if your liver tests rise.</li>
<li><strong>Diet and exercise</strong> — the usual anti-inflammatory pattern (see our <a href="/guides/diet">Diet Guide</a> and <a href="/guides/exercise">Exercise Guide</a>) supports general health and helps offset steroid side effects if you are also on prednisolone.</li>
<li><strong>Travel</strong> — get pre-travel advice 6–8 weeks ahead; some destinations need vaccines that must be planned around your immunosuppression.</li>
</ul>
...
<li>Once the dose is stable, prescribing handed to the <strong>GP under a shared-care agreement</strong>, with the rheumatology team still reviewing you 6–12 monthly</li>
</ul>
<p>Shared-care arrangements mean your GP can issue repeats, do your monitoring bloods and act on results — but anything unusual (low counts, raised liver enzymes, infections, planning pregnancy) should be flagged to your specialist team.</p>
...
<li>Who arranges my monitoring bloods — and what do I do if I'm called for one I can't attend?</li>
...
<li>It works slowly — expect 8–12 weeks for benefit, 3–6 months for full effect.</li>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:description" content="How azathioprine works in lupus, vasculitis and inflammatory arthritis — TPMT testing, dosing, side effects, monitoring and interactions." />
      ...
      <PageSchema
        ...
        description="How azathioprine works for lupus, vasculitis and inflammatory arthritis — TPMT testing, dosing, blood monitoring, side effects, interactions and pregnancy."
      ...
      <main className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-3xl py-16">
          <p className="speakable-intro text-lg md:text-xl text-foreground/85 leading-relaxed mb-8">
            ...
            the side effects and interactions to be aware of — written in plain English and
