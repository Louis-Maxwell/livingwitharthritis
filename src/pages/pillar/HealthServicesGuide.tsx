...
const HEALTH_SERVICES_FAQS = [
  ...
  { question: "Is physiotherapy free for arthritis in the UK?", answer: "Yes â€” physiotherapy is free on the public health service when referred by a GP, First Contact Physio or hospital clinician. Many areas also offer self-referral. Waits vary; private physiotherapy typically costs Â£40â€“Â£70 per session if you want faster access." },
  ...
  { question: "What support is available for mental health alongside arthritis?", answer: "Chronic pain and arthritis are linked to higher rates of depression and anxiety. The public health service offers Talking Therapies (self-referral in England), pain-management programmes that include psychological support, and dedicated chronic-pain services. Mention low mood to your GP â€” it's recognised as part of arthritis care." },
];
...
<p>In England alone, musculoskeletal (MSK) conditions account for approximately <strong>30% of all GP consultations</strong> (public health data, 2023). The health service spends an estimated <strong>Â£10.2 billion annually</strong> on musculoskeletal care, making it one of the largest areas of healthcare expenditure. Despite this, waiting times for rheumatology appointments have increased significantly since 2020, with some areas reporting waits of <strong>6â€“12 months</strong> for a first specialist appointment.</p>
...
<li>Request a <strong>choose and book</strong> appointment â€” you may find shorter waits at a hospital further away</li>
...
<li>Check if your area has an <strong>Early Inflammatory Arthritis (EIA) clinic</strong> â€” these are dedicated rapid-access services</li>
</ul>
...
<ul>
<li><strong>Individual assessment</strong> â€” a physiotherapist evaluates your mobility, strength, pain and function</li>
<li><strong>Tailored exercise programmes</strong> â€” specific to your joints and condition</li>
<li><strong>Group exercise classes</strong> â€” many local health trusts run arthritis-specific group sessions</li>
<li><strong>Hydrotherapy</strong> â€” warm-water exercise sessions available at some hospitals</li>
<li><strong>Manual therapy</strong> â€” hands-on treatment for joint mobilisation</li>
<li><strong>Education and self-management</strong> â€” teaching you to manage symptoms independently</li>
</ul>
<p>Access is via GP or FCP referral, or in some areas through <strong>self-referral</strong>. The health service website (<a href="https://www.gov.uk/browse/health-and-social-care" target="_blank" rel="noopener noreferrer">gov.uk/health</a>) lists self-referral physiotherapy services near you. Waiting times for public health physiotherapy typically range from <strong>4â€“12 weeks</strong>.</p>
...
<p>PMPs focus on:</p>
<ul>
<li><strong>Understanding pain</strong> â€” pain neuroscience education</li>
<li><strong>Pacing and activity management</strong> â€” avoiding boom-bust cycles</li>
<li><strong>Cognitive behavioural therapy (CBT)</strong> â€” changing unhelpful pain-related thoughts and behaviours</li>
<li><strong>Acceptance and Commitment Therapy (ACT)</strong> â€” psychological flexibility</li>
<li><strong>Graded exercise</strong> â€” building activity levels safely</li>
<li><strong>Medication review</strong> â€” optimising or reducing pain medication</li>
</ul>
<p>Referral is typically through your GP or rheumatologist. PMPs are available in most the public health service regions, though waiting times can be <strong>6â€“18 months</strong>.</p>
...
<ul>
<li><strong>Success rates</strong> â€” over 95% of patients report significant pain reduction; 90% of knee replacements last 15+ years</li>
<li><strong>Eligibility</strong> â€” based on clinical need, not age; assessed by orthopaedic surgeon</li>
<li><strong>Waiting times</strong> â€” the public health service target is 18 weeks, but actual waits average <strong>6â€“12 months</strong> in 2024</li>
<li><strong>Prehabilitation</strong> â€” many trusts now offer "prehab" programmes to optimise fitness before surgery</li>
<li><strong>Recovery</strong> â€” most patients return to normal activities within 3â€“6 months</li>
<li><strong>Cost</strong> â€” fully funded through the public health service; no charge to the patient</li>
</ul>
...
<p>The health service provides all medically necessary arthritis medications at standard prescription cost (currently <strong>Â£9.90 per item</strong> in England as of 2024; free in Scotland, Wales and Northern Ireland). Key medications include:</p>
<ul>
<li><strong>Paracetamol and NSAIDs</strong> â€” first-line pain relief</li>
<li><strong>Corticosteroids</strong> â€” short courses for flares, injections for localised inflammation</li>
<li><strong>DMARDs</strong> â€” methotrexate, sulfasalazine, hydroxychloroquine, leflunomide</li>
<li><strong>Biologics</strong> â€” adalimumab (Humira), etanercept (Enbrel), rituximab, tocilizumab, secukinumab</li>
<li><strong>JAK inhibitors</strong> â€” tofacitinib, baricitinib, upadacitinib</li>
</ul>
<p>If you take regular prescribed medication, a <strong>Prescription Prepayment Certificate (PPC)</strong> can save significant money. A 12-month PPC costs <strong>Â£111.60</strong> (2024) and covers unlimited prescriptions â€” worthwhile if you have more than 11 items per year.</p>
...
<ul>
<li><strong>IAPT (Improving Access to Psychological Therapies)</strong> â€” free CBT and counselling, self-referral available at <a href="https://www.gov.uk/browse/health-and-social-care" target="_blank" rel="noopener noreferrer">gov.uk/health</a></li>
<li><strong>Public health pain psychology</strong> â€” specialist psychologists within pain management teams</li>
<li><strong>Social prescribing</strong> â€” link workers who connect you with community activities, support groups and local services</li>
<li><strong>Crisis support</strong> â€” 111 helpline (option 2 for mental health crisis) or Samaritans 116 123</li>
</ul>
...
<ul>
<li><strong>Scotland</strong> â€” Scotland's health service provides free prescriptions for all. Musculoskeletal services are managed through Health Boards. The Scottish Intercollegiate Guidelines Network (SIGN) publishes its own clinical guidelines.</li>
<li><strong>Wales</strong> â€” Wales's health service also provides free prescriptions. Arthritis care is delivered through Local Health Boards. Wales has invested in community musculoskeletal services.</li>
<li><strong>Northern Ireland</strong> â€” Free prescriptions. Services delivered through Health and Social Care (HSC) trusts. Waiting times have historically been longer than England.</li>
<li><strong>England</strong> â€” Standard prescription charges apply (unless exempt). Services commissioned by Integrated Care Boards (ICBs). Most FCPs are deployed here.</li>
</ul>

<h2 id="how-to-get-the-most">How to Get the Most From Arthritis Services</h2>
<ul>
<li><strong>Prepare for appointments</strong> â€” write down your symptoms, questions and medication list</li>
<li><strong>Ask about self-referral</strong> â€” for physiotherapy, IAPT and some community services</li>
<li><strong>Use the public health service online services</strong> â€” book appointments, order repeat prescriptions and view records through the public health service App</li>
<li><strong>Request a care plan</strong> â€” if you have a long-term condition, you're entitled to an annual review and personalised care plan</li>
<li><strong>Know your rights</strong> â€” the public health service Constitution gives you the right to treatment within 18 weeks of referral</li>
<li><strong>Consider Patient Advice and Liaison Service (PALS)</strong> â€” if you're unhappy with your care</li>
<li><strong>Join a support group</strong> â€” many local health trusts partner with Versus Arthritis to run hospital-based support groups</li>
</ul>
...
export default function HealthServicesGuide() {
  ...
  return (
    <>
      ...
      <meta property="og:title" content="Arthritis Services UK â€“ GP, Rheumatology, Physio &amp; Joint Replacement Guide" />
      ...
      <meta name="twitter:title" content="Arthritis Services UK â€“ GP, Rheumatology, Physio &amp; Joint Replacement Guide" />
      ...
      <main id="main-content" className="min-h-screen bg-background">
        <PageHero
          ...
          subtitle="How to access free arthritis care through the public health service â€” from your first GP visit to specialist rheumatology, physiotherapy and joint replacement surgery."
          badge="Pillar Guide"
        />
