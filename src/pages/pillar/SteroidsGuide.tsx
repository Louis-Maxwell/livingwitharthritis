...
const STEROID_FAQS = [
  { question: "What is a steroid injection for arthritis?", answer: "A steroid (corticosteroid) injection delivers a small dose of synthetic cortisone directly into an inflamed joint or the soft tissue around it. The medication dampens the inflammation that causes pain, swelling and stiffness â€” typically giving relief that lasts a few weeks to several months. Common drugs used include methylprednisolone, triamcinolone and hydrocortisone." },
  { question: "How long does a steroid injection last for joint pain?", answer: "Most people feel improvement within 24â€“72 hours. Pain relief typically lasts 6 weeks to 6 months, depending on the joint, the severity of inflammation and the type of arthritis. Knees and shoulders often respond well; smaller joints in the hands may give shorter relief." },
  { question: "What are the side effects of steroids for arthritis?", answer: "Short-term: a temporary flare of pain in the first 24â€“48 hours, facial flushing, raised blood sugar (especially in people with diabetes), mild mood changes and skin thinning or pigment change at the injection site. Long-term or repeated use can weaken cartilage, increase infection risk, cause weight gain, osteoporosis and high blood pressure. This is why injections are usually limited to 3â€“4 per joint per year." },
  ...
  { question: "How often can I have steroid injections?", answer: "Most clinicians limit injections to a maximum of 3â€“4 per joint per year, with at least 3 months between injections in the same joint. Repeated frequent injections can accelerate cartilage damage in osteoarthritis." },
  { question: "Do steroid injections work for osteoarthritis of the knee?", answer: "Evidence shows steroid injections give short-term pain relief (typically 4â€“8 weeks) for knee osteoarthritis, particularly during flare-ups. NICE guidance (NG226) supports their use as an option when conservative treatment hasn't controlled symptoms, but they should not be the first or only treatment." },
];

const CONTENT = `
<h2 id="overview">Steroids for arthritis: an overview</h2>
<p>Corticosteroids â€” often shortened to "steroids" â€” are one of the most widely used treatments for inflammatory joint pain. They are synthetic versions of <strong>cortisol</strong>, a hormone the body produces naturally, and they work by switching off the chemical signals that cause inflammation, swelling and pain.</p>
...
<p>Steroids do not slow the underlying disease in osteoarthritis, and they are not a long-term solution. What they offer is a window of relief â€” often enough to get someone moving, sleeping, exercising or completing physiotherapy that would otherwise be impossible because of pain.</p>

<h2 id="how-they-work">How steroids work in an inflamed joint</h2>
<p>In a healthy joint, the synovial lining produces a small amount of lubricating fluid. In inflammatory arthritis (rheumatoid arthritis, psoriatic arthritis, gout) and during osteoarthritis flares, this lining becomes thickened and produces excess fluid loaded with inflammatory chemicals â€” prostaglandins, cytokines and white blood cells.</p>
...
<ul>
<li><strong>Methylprednisolone (Depo-Medrone)</strong> â€” medium-acting, widely used for knees, shoulders and hips</li>
<li><strong>Triamcinolone (Kenalog)</strong> â€” longer-acting, often used for larger joints and tendon sheaths</li>
<li><strong>Hydrocortisone</strong> â€” shorter-acting, sometimes used in smaller joints like fingers</li>
</ul>
<p>The injection is usually mixed with a small dose of local anaesthetic (lidocaine), which gives almost immediate but brief pain relief while the steroid begins to work over the following 24â€“72 hours.</p>

<h2 id="what-to-expect">What to expect during a joint injection</h2>
<p>A joint injection takes about 10â€“15 minutes from start to finish. You can drive yourself home afterwards. Here is what typically happens:</p>
<ul>
...
<li>A small plaster is applied; you rest the joint for 24â€“48 hours</li>
</ul>
...
<ul>
<li><strong>Post-injection flare</strong> â€” a temporary increase in pain for 24â€“48 hours, experienced by 1 in 20 people</li>
<li><strong>Facial flushing</strong> â€” warmth and redness lasting a day or two</li>
<li><strong>Raised blood sugar</strong> â€” important if you have diabetes; monitor closely for 3â€“5 days</li>
<li><strong>Skin changes</strong> â€” thinning or loss of pigment at the injection site (more visible in darker skin)</li>
<li><strong>Mood or sleep disturbance</strong> â€” brief and self-limiting</li>
</ul>
<p>Rare but more serious risks include joint infection (less than 1 in 10,000), tendon weakening if injected too close to a tendon, and accelerated cartilage loss with repeated injections. This is why most clinicians limit injections to a maximum of <strong>3â€“4 per joint per year</strong>.</p>

<h2 id="oral-steroids">Oral steroids and inflammatory arthritis</h2>
<p>For people with <strong>rheumatoid arthritis</strong>, <strong>polymyalgia rheumatica</strong>, <strong>lupus</strong> or <strong>vasculitis</strong>, short courses of oral steroids â€” usually prednisolone â€” are a standard part of treatment. They are used as a "bridge" to control inflammation rapidly while slower disease-modifying drugs (methotrexate, sulfasalazine, biologics) take effect over 6â€“12 weeks.</p>
<p>Typical regimens range from a short tapering course over a few weeks to longer maintenance doses in conditions like polymyalgia rheumatica, which may need treatment for 1â€“2 years.</p>
<p>Long-term oral steroids carry meaningful risks â€” weight gain, raised blood pressure, osteoporosis, increased infection risk and changes to blood sugar control. Anyone taking prednisolone for more than 3 months should be assessed for <strong>bone protection</strong> (calcium, vitamin D and often a bisphosphonate) under NICE guidance.</p>

<h2 id="osteoarthritis">Steroids for osteoarthritis: what the evidence says</h2>
<p>NICE guidance (NG226, 2022) lists intra-articular steroid injections as an option for osteoarthritis when other measures have not controlled symptoms. Cochrane reviews show short-term pain relief of <strong>4â€“8 weeks</strong> for knee osteoarthritis, with less convincing evidence for hip and hand osteoarthritis.</p>
<p>Steroids do not slow cartilage loss in osteoarthritis, and there is some evidence that frequent repeat injections (more than 4 per year in the same joint) may accelerate it. For this reason they are best used <strong>strategically</strong> â€” to break a flare-up cycle, to enable physiotherapy, or to bridge the wait for joint replacement surgery â€” rather than as a routine treatment.</p>
...
<ul>
<li><strong>Hyaluronic acid injections</strong> â€” sometimes offered for knee osteoarthritis, though NICE no longer routinely recommends them on the public health service</li>
<li><strong>Platelet-rich plasma (PRP)</strong> â€” privately available; evidence is mixed and improving</li>
<li><strong>Topical NSAIDs</strong> â€” diclofenac or ibuprofen gels are first-line for hand and knee osteoarthritis</li>
<li><strong>Oral pain relief</strong> â€” paracetamol, short courses of oral NSAIDs with stomach protection</li>
<li><strong>Strengthening exercise and weight management</strong> â€” the strongest evidence base for long-term improvement in osteoarthritis</li>
<li><strong>Disease-modifying drugs (DMARDs)</strong> â€” for inflammatory arthritis, the foundation of long-term control</li>
</ul>
...
<ul>
<li><strong>Your GP</strong> â€” many GPs are trained to inject knees, shoulders and the base of the thumb</li>
<li><strong>First Contact Physiotherapists</strong> â€” increasingly trained as independent prescribers and joint injectors; bookable without a GP referral</li>
<li><strong>Rheumatology clinics</strong> â€” for inflammatory arthritis and complex small-joint injections</li>
<li><strong>Orthopaedic outpatients</strong> â€” when injections are part of a surgical pathway</li>
<li><strong>Musculoskeletal interface services</strong> â€” local triage clinics that can inject larger joints quickly</li>
</ul>
<p>Private steroid injections typically cost Â£150â€“Â£300 per joint and are available through physiotherapy clinics, MSK specialists and private rheumatologists if you need faster access.</p>
...
<li>What should I do â€” and avoid â€” in the 48 hours after the injection?</li>
...
<li>Injections work best when used <strong>strategically</strong> â€” to break a flare or enable rehabilitation â€” not as a long-term routine.</li>
<li>Limit injections to <strong>3â€“4 per joint per year</strong> to protect cartilage.</li>
...
export default function SteroidsGuide() {
  ...
  return (
    <>
      <Helmet>
        <title>Steroids for Arthritis â€” UK Guide | Living With Arthritis</title>
        ...
        <meta property="og:title" content="Steroids for Arthritis â€“ Injections, Tablets, Side Effects &amp; UK Access Guide" />
        ...
        <meta name="twitter:title" content="Steroids for Arthritis â€“ Injections, Tablets, Side Effects &amp; UK Access Guide" />
      ...
      <main id="main-content" className="min-h-screen bg-background">
        <PageHero
          ...
          subtitle="A plain-English guide to corticosteroid injections and tablets â€” how they work, what to expect, side effects and how to access them in the UK."
          badge="Pillar Guide"
        />
