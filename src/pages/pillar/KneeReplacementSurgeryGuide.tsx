...
const KNEE_REPLACEMENT_FAQS = [
  ...
  { question: "What is the UK waiting list for a knee replacement?", answer: "As of 2024, the median public-system wait for a knee replacement in England is around 18–22 weeks from referral, though some trusts exceed 40 weeks. You have the legal right under the UK Patient Charter to be treated within 18 weeks of referral and can request alternative providers if waits exceed this." },
...
<p>Knee replacement is a routine UK operation. Under the UK Patient Charter you have the right to be treated within <strong>18 weeks of referral</strong>. If your local trust cannot meet this, you can ask to be transferred to another public or publicly funded independent provider — this is sometimes called the <strong>"right to choose"</strong>.</p>
