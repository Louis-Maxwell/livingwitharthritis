...
const KNEE_REPLACEMENT_FAQS = [
  ...
  { question: "How long is recovery from knee replacement surgery on the NHS?", answer: "Most patients are discharged within 1–3 days. You can usually walk with crutches within 24 hours, drive at 6 weeks, and return to desk work at 6–8 weeks. Full recovery — including swelling reduction and maximum strength — typically takes 6–12 months. Daily physiotherapy exercises are essential during this period." },
  { question: "What is the NHS waiting list for a knee replacement?", answer: "As of 2024, the median NHS wait for a knee replacement in England is around 18–22 weeks from referral, though some trusts exceed 40 weeks. You have the legal right under the NHS Constitution to be treated within 18 weeks of referral and can request alternative providers if waits exceed this." },
...
<p>Knee replacement is a routine NHS operation. Under the NHS Constitution you have the right to be treated within <strong>18 weeks of referral</strong>. If your local trust cannot meet this, you can ask to be transferred to another NHS or NHS-funded independent provider — this is sometimes called the <strong>"right to choose"</strong>.</p>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Evidence-based UK patient guide to knee replacement surgery: when to consider it, prehab, what happens in hospital, recovery timeline, exercises, risks and NHS waiting list options." />
        ...
        <meta property="og:description" content="Comprehensive UK patient guide to knee replacement surgery: decision-making, prehab, hospital stay, week-by-week recovery, exercises, risks and how to manage NHS waiting lists." />
        ...
        <meta name="twitter:description" content="Evidence-based UK patient guide to knee replacement surgery: when to consider it, prehab, recovery timeline, exercises, risks and NHS waiting list options." />
      ...
      <PageSchema
        ...
        description="Evidence-based UK patient guide to knee replacement surgery, prehab, recovery, exercises, risks and NHS waiting list options."
