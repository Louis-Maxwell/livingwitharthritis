...
const keyFacts = [
  ...
  { icon: Shield, stat: "NHS", label: "Aligned with NHS clinical guidelines" },
...
const spokespeople = [
  {
    ...
    bio: "Qualified physiotherapist with extensive experience in musculoskeletal health. Founded Living With Arthritis UK to bridge the gap between NHS waiting lists and accessible patient support.",
  },
  {
    name: "Clinical Lead",
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Our services are delivered by HCPC-registered physiotherapists and aligned with current NHS and NICE clinical guidelines. We believe no one should face arthritis alone, and no one should have to wait months on an NHS list for basic support.
            </p>
