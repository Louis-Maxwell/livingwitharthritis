...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Knee Arthritis", "item": URL }
  ]
};
...
const KneeArthritis = () => (
  <>
    <Helmet>
      <title>Knee Arthritis – Symptoms, Exercises & Treatment | Living With Arthritis</title>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 md:px-10 py-12 md:py-16 max-w-3xl">
        ...
        <div className="p-8 rounded-2xl bg-accent border border-border/30">
          ...
          <p className="text-muted-foreground mb-5">Chat with our AI assistant or browse the Advice Hub for joint-specific articles.</p>
