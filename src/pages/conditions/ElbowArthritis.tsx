...
const jsonLd = {
  ...
  "description": "UK guide to elbow pain and elbow arthritis: causes of elbow joint pain, tennis and golfer's elbow, osteoarthritis and rheumatoid involvement, the best gentle exercises, NHS treatment options and when to see a GP.",
  "url": URL,
  "inLanguage": "en-GB",
...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Elbow Arthritis", "item": URL }
  ]
};
      ...
      <main className="container mx-auto px-6 md:px-10 py-12 md:py-16 max-w-3xl">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <EmojiCard emoji="🔁" title="Mobility" description="Bend / straighten morning &amp; evening" />
            <EmojiCard emoji="🤏" title="Grip" description="Soft-ball squeezes daily" />
            <EmojiCard emoji="🎒" title="Load" description="Backpack, not single-shoulder bag" />
