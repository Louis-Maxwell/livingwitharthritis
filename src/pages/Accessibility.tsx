...
const STATIC_FEATURES = [
  ...
  { icon: Globe, title: "Language & Localisation", desc: "Content is written in plain English (en-GB) at an average reading age of 12–14 years, following NHS content design principles for health literacy." },
