...
const resources: Record<string, Resource[]> = {
  ...
  "Equipment & Aids": [
    { name: "Local Equipment Services", description: "Your local authority or local health trust can provide mobility aids, daily living equipment, and home adaptations through an occupational therapy assessment.", region: "Nationwide", tags: ["the health service", "OT"], featured: true },
