...
const FAQS = [
  ...
  { q: 'How much protein do I need?', a: 'Older adults benefit from 1.0â€“1.2 g of protein per kg body weight daily â€” higher than the standard 0.8 g/kg â€” split into 25â€“30 g servings across meals.' },
  ...
  { q: 'Do supplements help sarcopenia?', a: 'Vitamin D, creatine and leucine-rich protein (whey, dairy) have the strongest evidence. Always pair supplements with resistance training â€” neither works alone.' },
  ...
  useEffect(() => {
    ...
    const howto = {
      ...
      step: [
        ...
        { '@type': 'HowToStep', name: 'Lower', text: 'Lower over 3 seconds. Repeat 10â€“15 times each leg, 2 sets daily.' },
      ],
    };
  ...
  return (
    <article className="max-w-4xl mx-auto py-12 px-4">
      ...
      <AnswerBox question="What is sarcopenia and how is it linked to arthritis?" reviewed="2026-06-21">
        Sarcopenia is age-related loss of muscle mass and strength. Arthritis accelerates it because joint pain reduces activity and chronic inflammation breaks down muscle. Prevention combines 1.0â€“1.2 g/kg/day protein, twice-weekly resistance training, vitamin D, and treating pain so movement stays possible.
      </AnswerBox>
      ...
      <section id="what" className="mb-12">
        ...
        <p className="leading-relaxed mb-4">Muscle mass declines about 1% per year from age 40, and strength declines faster â€” around 3% per year after 60. Arthritis multiplies this loss: pain limits movement, inflammatory cytokines (IL-6, TNF-Î±) drive muscle breakdown, and steroid medications worsen it further.</p>
      ...
      <section id="protein" className="mb-12">
        ...
        <p className="leading-relaxed mb-4">Aim for 1.0â€“1.2 g/kg body weight daily. A 70 kg adult needs 70â€“84 g. Split across 3 meals â€” 25â€“30 g each â€” to maximise muscle protein synthesis. Leucine-rich sources (whey, eggs, dairy, fish, chicken, soya) are most effective.</p>
      ...
      <section id="strength" className="mb-12">
        ...
        <p className="leading-relaxed mb-4">Two sessions per week targeting all major muscle groups: legs (sit-to-stand, step-ups), hips (bridges, clamshells), back (band rows), chest (wall push-ups) and core. Use 8â€“12 reps at a load you can just complete.</p>
      ...
      <section id="supplements" className="mb-12">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Vitamin D:</strong> 10â€“25 Âµg/day, especially Octoberâ€“March (UK healthcare guidance).</li>
          <li><strong>Creatine monohydrate:</strong> 3â€“5 g/day, combined with resistance work, modestly improves strength in older adults.</li>
          <li><strong>Whey protein:</strong> 20â€“30 g post-exercise to top up leucine.</li>
          <li><strong>Omega-3:</strong> 2â€“3 g/day EPA+DHA may reduce muscle protein breakdown.</li>
        </ul>
