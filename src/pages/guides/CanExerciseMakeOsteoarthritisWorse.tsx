...
const FAQS = [
  {
    ...
    answer:
      "No â€” for the vast majority of people, appropriate exercise does not wear joints out and does not accelerate osteoarthritis. UK NICE guidance (NG226) places exercise ahead of medication as the first-line treatment. Cartilage actually responds to gentle, repeated load by becoming better nourished. Problems arise from doing too much too soon, sudden high-impact loading, or ignoring acute flares â€” not from movement itself.",
  },
  {
    question: "Is the pain I feel during exercise damaging my joints?",
    answer:
      "Usually not. A mild ache up to about 4/10 during or after exercise that settles within 24 hours is normal and safe. Sharp, catching, or locking pain â€” or swelling and pain that stays high overnight â€” is a signal to reduce load, not to stop moving altogether.",
  },
  {
    question: "What's the difference between productive soreness and a flare?",
    answer:
      "Productive soreness feels diffuse, eases as you warm up, and settles within a day. A flare feels hot, swollen, sharp or stiff for more than 24â€“48 hours, and often comes with reduced range of motion. During a flare, switch to gentle range-of-motion work, water-based exercise, or rest the joint for 24â€“48 hours, then rebuild gradually.",
  },
  {
    question: "Should I rest if my knees or hips hurt?",
    answer:
      "Short rest (24â€“48 hours) is reasonable during an acute flare, but prolonged rest makes osteoarthritis worse. Inactivity weakens the muscles that protect your joints, stiffens cartilage, and increases pain sensitivity. Movement â€” even gentle â€” is almost always part of the answer.",
  },
  {
...
<p>No â€” for almost everyone with osteoarthritis, exercise <strong>does not make the condition worse</strong>. The opposite is true. UK <strong>NICE guidance (NG226)</strong> places structured exercise <em>ahead of medication</em> as the first-line treatment for osteoarthritis of the knee, hip and hand. The Chartered Society of Physiotherapy describes movement as "the single most important thing you can do" for arthritic joints.</p>
...
<ul>
<li><strong>Mechanical intuition.</strong> Joints look like hinges, and hinges wear out with use. But cartilage is not a mechanical surface â€” it is metabolically active tissue that depends on loading for its nutrient supply.</li>
...
<li><strong>Bad early experiences.</strong> Doing too much too soon â€” long walks, heavy gardening, a sudden gym programme â€” provokes a flare, which then reinforces the fear of moving at all.</li>
</ul>
...
<li><strong>Flare pain (back off).</strong> Sharp, catching or locking sensations. Hot, swollen joints. Pain that stays above 4/10 for more than 24â€“48 hours or wakes you at night. Reduced range of motion.</li>
</ul>
<p>Productive soreness is part of normal adaptation and can be exercised through. Flare pain is a signal to reduce load â€” not to stop moving altogether.</p>

<h2 id="balancing-rest-and-movement">A practical framework for balancing rest with movement</h2>
<p>The goal is steady, sustainable activity â€” not heroic effort followed by long recovery. Use this five-step framework:</p>
<ol>
...
<li><strong>Modify, don't stop, during flares.</strong> Switch to gentle range-of-motion work, water-based exercise, or seated movement for 24â€“48 hours. Returning to gentle activity quickly prevents deconditioning.</li>
    ...
    <>
      ...
      <main id="main-content" className="min-h-screen bg-background">
        <PageHero
          ...
          subtitle="The short answer is no. NICE puts exercise ahead of medication for osteoarthritis. Here's how to move with confidence â€” and how to tell productive soreness from a flare."
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-3xl py-16">
          <p className="speakable-intro text-lg md:text-xl text-foreground/85 leading-relaxed mb-8">
            ...
            soon â€” not from movement itself. Start small, progress slowly, and
