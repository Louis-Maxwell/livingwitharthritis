...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Rotator cuff pain typically improves substantially over 6–12 weeks of consistent exercise. Frozen shoulder is slower — it runs a natural course of 12–30 months, though exercise and, where appropriate, a corticosteroid injection shorten the painful phase. Osteoarthritis is managed rather than cured, but pain and function usually improve within 8–12 weeks of a structured routine.",
  },
  {
...
<ul>
<li><strong>Rotator cuff related shoulder pain</strong> (roughly 70% of cases) — pain on the outer upper arm, worst when reaching overhead, out to the side, or behind your back to fasten a seatbelt.</li>
<li><strong>Frozen shoulder (adhesive capsulitis)</strong> — the joint capsule thickens and tightens. The hallmark is loss of movement in <em>every</em> direction, including when someone else lifts your arm for you. More common between 40 and 60, and in people with diabetes or thyroid disease.</li>
<li><strong>Shoulder osteoarthritis</strong> — deep, grinding pain, morning stiffness that eases within about 30 minutes, and sometimes an audible crunch on movement. It affects the main ball-and-socket joint or the smaller acromioclavicular joint on top of the shoulder.</li>
<li><strong>Inflammatory arthritis</strong> — rheumatoid arthritis and polymyalgia rheumatica both commonly involve the shoulders, typically with stiffness lasting well over an hour in the morning and often affecting both sides.</li>
</ul>
...
<p>Add these once daily mobility work is comfortable — usually after one to two weeks. Use a light resistance band or a tin of beans; the rotator cuff responds to control, not heavy load.</p>
<ul>
...
<li><strong>Band external rotation.</strong> Elbow tucked at your side at 90 degrees, band anchored at waist height, rotate the forearm outwards away from your body. 2–3 sets of 10.</li>
<li><strong>Band internal rotation.</strong> The same setup, rotating inwards across your stomach. 2–3 sets of 10.</li>
...
<ul>
<li><strong>Every day</strong> — the eight-minute mobility routine, ideally after a warm shower.</li>
<li><strong>Monday, Wednesday, Friday</strong> — add the strengthening set (about 15 minutes).</li>
<li><strong>Most days</strong> — 20–30 minutes of walking. General activity reduces pain sensitivity across all joints, shoulders included, and counts toward the UK Chief Medical Officer target of 150 minutes of moderate activity weekly.</li>
</ul>
<p>Three short sessions a week sustained for three months beat an intensive fortnight followed by abandonment. Track how the shoulder feels the morning after each session rather than during it — the next-morning response is the honest signal.</p>
...
<p>If six to eight weeks of consistent exercise has not shifted the pain, options in the UK include a referral to musculoskeletal physiotherapy (self-referral is available in most areas), a corticosteroid injection — most useful for frozen shoulder and acutely inflamed cuff pain, and best combined with continued exercise rather than used alone — and imaging or a specialist opinion if a full-thickness cuff tear or advanced osteoarthritis is suspected. Surgery is a late option and, for most rotator cuff pain, no better than a well-delivered exercise programme in trial comparisons.</p>

<h2 id="red-flags">Red flags — seek medical advice promptly</h2>
...
<p>Start today with the pendulum swings and cross-body reach — two minutes total. Build to the full mobility routine over the coming week, then add strengthening. Most people with rotator cuff pain see a clear improvement within six weeks of doing this consistently.</p>
...
export default function ShoulderPainRelief() {
  ...
  const description =
    "Why your shoulder is in pain and how to relieve it — a staged mobility and strengthening routine, fast-relief measures, red flags and when to see a GP.";
