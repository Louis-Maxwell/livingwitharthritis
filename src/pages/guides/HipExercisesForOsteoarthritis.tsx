...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "A mild ache up to about 4/10 during or after exercise that settles within 24 hours is normal and safe to continue with. Sharp, catching or groin pain that stays high overnight is a signal to reduce load â€” swap to shorter sets, water-based work or gentle range-of-motion â€” rather than stop moving altogether.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Most people notice less stiffness and easier walking within two to four weeks of a consistent programme, with pain and strength improvements building over 8â€“12 weeks. NICE-recommended structured exercise programmes for hip OA typically run for at least six weeks before their full effect is measured.",
  },
  {
    question: "Can exercise delay or avoid a hip replacement?",
    answer:
      "For many people, yes. Strengthening the hip abductors, glutes and quadriceps reduces pain, improves function and can delay the need for surgery â€” sometimes by years. If a replacement does become necessary, entering surgery with strong surrounding muscles (\"prehabilitation\") is one of the strongest predictors of a fast, successful recovery.",
  },
  {
...
<ul>
<li><strong>Cartilage nutrition.</strong> Cartilage has no blood supply. It feeds through gentle, repeated compression â€” exactly what walking, cycling and squatting provide.</li>
...
<li><strong>Pain modulation.</strong> Exercise reduces the sensitivity of pain pathways over 6â€“12 weeks â€” a real physiological effect, not distraction.</li>
</ul>
...
<p>Use the <strong>4/10 pain rule</strong>: mild ache up to 4/10 during or after exercise, settling within 24 hours, is safe. Anything sharper, or pain lasting longer than a day, means dial back â€” don't stop.</p>

<h2 id="warm-up">Warm-up (2â€“3 minutes)</h2>
<p>Start every session by getting blood into the muscles and the joint moving through its available range.</p>
<ul>
<li><strong>Marching on the spot</strong> â€” 60 seconds, lifting knees to a comfortable height.</li>
<li><strong>Hip circles</strong> â€” hold a chair, stand on one leg, circle the other leg gently in each direction. 10 each way, per side.</li>
<li><strong>Standing hip swings</strong> â€” hold a wall, swing one leg forward and back with a relaxed knee. 10 each side.</li>
</ul>

<h2 id="core-routine">The core routine â€” 8 hip exercises</h2>
<p>Aim for 2â€“3 sets of 8â€“12 repetitions of each strength exercise, unless a different target is given. Move slowly, breathe out on the effort, and stop 1â€“2 reps short of failure. Rest 30â€“60 seconds between sets.</p>

<h3 id="ex-1">1. Side-lying hip abduction</h3>
<p>Lie on your side, bottom leg bent for balance, top leg straight. Lift the top leg toward the ceiling to about 30Â° â€” no higher â€” keeping the toes pointing forward, not up. Lower with control. <em>Targets:</em> gluteus medius, the primary hip stabiliser.</p>
...
<p>Hold a chair or worktop for balance. Standing tall, kick one leg straight backward about 15â€“20 cm without leaning forward. Keep the movement small and the glute working. Return with control. <em>Targets:</em> gluteus maximus, hip mobility into extension (usually the first range hip OA loses).</p>

<h3 id="ex-5">5. Sit-to-stand</h3>
<p>From a firm chair, cross your arms and stand up without using your hands, then sit back down under control. If that's too hard, use your hands at first and progress to arms-crossed over 2â€“3 weeks. Aim for 2 sets of 10. <em>Targets:</em> quadriceps and glutes together â€” the most functional strength exercise for hip and knee OA.</p>

<h3 id="ex-6">6. Mini squat</h3>
<p>Stand with feet hip-width apart, holding a worktop lightly for balance. Bend your knees and hips to lower about 15â€“20 cm, keeping your weight in your heels. Stand up. <em>Targets:</em> whole lower-body chain. Progress by holding the bottom position for 3 seconds.</p>

<h3 id="ex-7">7. Standing hip flexion (marching)</h3>
<p>Stand tall, hold a chair for balance. Lift one knee to a comfortable height â€” hip level if you can â€” pause for one second, lower slowly. Alternate legs. <em>Targets:</em> hip flexors and balance.</p>

<h3 id="ex-8">8. Cool-down stretches â€” hamstring &amp; hip flexor</h3>
<p>Finish with two gentle 30-second holds per side. Hamstring: sit on the edge of a chair, straighten one leg with the heel on the floor, hinge forward until you feel a stretch behind the thigh. Hip flexor: kneel on a cushion with one foot in front, tuck the pelvis under and gently press the hips forward until you feel a stretch at the front of the back hip. Never stretch into pain â€” a gentle pull is enough.</p>

<h2 id="weekly-plan">A sensible weekly plan</h2>
<ul>
<li><strong>Strength routine</strong> â€” 2â€“3 sessions per week on non-consecutive days.</li>
<li><strong>Low-impact aerobic work</strong> â€” walking, cycling, swimming or water aerobics on the other days, working toward 150 minutes of moderate activity per week.</li>
<li><strong>Mobility &amp; balance</strong> â€” a weekly tai chi or yoga class if possible; both have strong evidence for hip OA function and fall prevention.</li>
</ul>
...
<p><strong>During a flare</strong> (24â€“48 hours of hot, sharper pain) drop to gentle range-of-motion work only: hip circles, seated marches, glute squeezes, short water walks. Return to the full routine within a week â€” prolonged rest deconditions the joint and prolongs the flare.</p>
...
<p>Pick two of the eight exercises above and do them today â€” even one set is enough to start. Add the rest over the coming fortnight. Track how the hip feels the morning after each session. Within three to six weeks you should notice easier walking, less morning stiffness and more confidence on stairs.</p>
...
export default function HipExercisesForOsteoarthritis() {
  ...
  const description =
    "A safe, NICE-aligned home routine of eight hip exercises for osteoarthritis â€” with warm-up, weekly plan, flare-up modifications and progression rules.";
    ...
    <>
      ...
      <main id="main-content" className="min-h-screen bg-background">
        <PageHero
          ...
          subtitle="A safe, physio-aligned home routine â€” eight moves, a weekly plan, and clear rules for progressing without provoking a flare."
        ...
        <div className="container mx-auto px-5 md:px-10 max-w-3xl py-16">
          <p className="speakable-intro text-lg md:text-xl text-foreground/85 leading-relaxed mb-8">
            ...
            clear rules for flare-ups â€” everything you need to start at home
            today.
          </p>
