  ...
  return (
    <article className="max-w-4xl mx-auto py-12 px-4">
      <SeoHead
        ...
        description="Early intervention guide for adults 40–60 with arthritis risk. Posture, load management, exercise and when to see a physio — HCPC reviewed."
        path="/guides/preventative-msk-health"
        type="article"
        keywords="prevent arthritis, early arthritis signs, msk health, joint health, preventative physiotherapy"
      />
      ...
      <section id="posture" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">2. The role of posture and movement patterns</h2>
        <p className="leading-relaxed mb-4">There is no single "perfect" posture. The body needs variety. Long hours in one position — at a desk, on a sofa, behind the wheel — overload specific tissues. Aim to change position every 30–45 minutes and strengthen muscles that support your daily postures.</p>
      </section>

      <section id="load" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">3. Load management during daily activities</h2>
      ...
      <section id="exercise" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">4. Preventative exercise: which joints to target first</h2>
      ...
      <section id="when" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">5. When to see a physio, GP or specialist</h2>
        <ul className="list-disc pl-6 space-y-2">
