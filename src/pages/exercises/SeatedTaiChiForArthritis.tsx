...
const whoFor = [
  { icon: Accessibility, title: "Severe knee or hip OA", text: "Standing for long is painful or unsafe â€” but you still want the proven benefits of tai chi for stiffness and mood." },
...
const moves = [
  ...
  },
  {
    ...
    why: "Wakes up the hips and core stabilisers safely â€” the seated equivalent of standing weight-shifts.",
  },
  {
    name: "Seated Cloud Hands",
    duration: "3 min",
    how: "Sweep your left hand across your body at chest height as if wiping a window, palm facing you. As it crosses, gently turn your torso. Alternate with right hand. Keep movements slow â€” 8 reps.",
  ...
  },
  {
    ...
    why: "Coordinates upper body with breath â€” keeps the practice flowing without standing.",
  },
  {
    ...
    why: "Down-regulates the nervous system â€” research links this to reduced pain perception.",
  },
];

const safety = [
  "Use a sturdy chair without wheels. Avoid sofas â€” they're too soft for a stable base.",
  "If your chair has arms, that's fine â€” just keep elbows free to move.",
...
const faqs = [
  { q: "Is seated tai chi safe for arthritis?", a: "Yes â€” seated tai chi is one of the safest forms of exercise for arthritis. Practising from a sturdy chair removes fall risk, takes weight off painful knees and hips, and keeps movement within a comfortable range. It's suitable during mild flares (stop only if movement increases pain), and is often the first exercise UK physiotherapists recommend for severe OA or post-surgical recovery." },
  { q: "Is seated tai chi safe if I have severe arthritis or use a wheelchair?", a: "Yes. Seated tai chi was designed precisely for people whose joints can't tolerate standing practice. Lock wheelchair brakes, sit as upright as your back allows, and follow upper-body movements only if leg movement is uncomfortable. Skip any posture that provokes sharp pain â€” the practice still works with a smaller range of motion." },
  { q: "Can I do seated tai chi after hip or knee replacement surgery?", a: "Most UK orthopaedic surgeons clear patients for gentle seated movement within 2â€“4 weeks of surgery, but always confirm with your own surgical team first. Seated tai chi is an excellent bridge between bed rest and standing rehab â€” it maintains upper-body strength, improves circulation, and rebuilds confidence in movement without stressing the new joint." },
  { q: "Is seated tai chi as effective as standing tai chi?", a: "For balance and lower-limb strength, standing practice has more evidence. But for stiffness, mood, breathing and upper-body mobility, seated tai chi delivers most of the same benefits â€” and it's far better than no practice at all. Many people alternate seated and standing days based on how their joints feel." },
  ...
  { q: "How often should I practise?", a: "Start with 15 minutes, 3 times a week. Daily 10-minute sessions also work well. Consistency matters more than length â€” aim to make it a habit before lengthening sessions." },
  { q: "Is there a UK chair-based tai chi class I can join?", a: "Many UK Age UK branches, UK healthcare social-prescribing schemes and local leisure trusts run chair-based exercise classes that include tai chi elements. Search the Tai Chi Union for Great Britain directory for instructors who offer seated adaptations." },
];
...
export default function SeatedTaiChiForArthritis() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHero
        badge={<Badge variant="secondary" className="bg-background text-primary border-0">Chair-based Â· No equipment</Badge>}
        title="Seated Tai Chi for Arthritis"
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-6 md:px-12 max-w-[1200px]">
          <div className="max-w-2xl mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">Seated tai chi keeps the flowing rhythm and breathing of standing practice â€” without loading painful joints or risking a fall.</p>
          </div>
      ...
      <section id="routine" className="py-16 lg:py-24 bg-secondary/30 border-y border-border/15">
        <div className="container mx-auto px-6 md:px-12 max-w-[1000px]">
          <div className="max-w-2xl mb-10">
            <Badge variant="secondary" className="mb-4 bg-background text-primary border-0">13 minutes Â· 5 movements</Badge>
