...
const benefits = [
  { icon: Shield, title: "NICE-recommended", text: "UK NICE guidelines (NG226) explicitly recommend tai chi as a therapeutic exercise option for osteoarthritis â€” one of only a handful of named non-drug interventions." },
  ...
  { icon: Heart, title: "Lowers fall risk by ~20%", text: "A 2017 Cochrane review of 7,494 older adults found tai chi reduced fall rate by approximately 20% â€” a key concern when arthritis affects balance." },
...
const jointLinks = [
  ...
  { joint: "Back", slug: "tai-chi-for-back-arthritis", note: "Encourages a tall spine and gentle rotation â€” ideal for spinal OA." },
...
const movementLibrary: { key: keyof typeof TAI_CHI_ANIMATIONS; name: string; brief: string; cue: string; bestFor: string }[] = [
  { key: "rooted-stance", name: "Rooted Stance (Wuji)", brief: "The starting posture every form returns to â€” feet hip-width, knees soft, spine tall.", cue: "Soft knees over toes. Crown lifts gently.", bestFor: "All joints Â· posture Â· breath" },
  { key: "weight-shift", name: "Weight Shift", brief: "Slow lateral transfer of body weight without lifting the feet â€” the engine of every tai chi form.", cue: "Side-to-side, feet flat. The engine of every move.", bestFor: "Knee Â· hip Â· ankle Â· balance" },
  ...
  { key: "brush-knee", name: "Brush Knee", brief: "Step forward, brush past the knee with one hand and push with the other â€” coordination plus mobility.", cue: "Brush past the knee, push the other hand forward.", bestFor: "Knee Â· hip Â· whole-body" },
  { key: "closing-posture", name: "Closing Posture", brief: "The grounding sequence that ends every set â€” settles breath and joint warmth.", cue: "Lower the hands, settle the weight, exhale.", bestFor: "All joints Â· cool-down" },
];

const ukResources = [
  { name: "Tai Chi Union for Great Britain", url: "https://taichiunion.com/", desc: "UK governing body â€” searchable directory of accredited instructors." },
  { name: "Tai Chi for Health Institute (UK chapters)", url: "https://taichiforhealthinstitute.org/", desc: "Sun-style 'Tai Chi for Arthritis' programme â€” the form most often referenced in NICE-aligned trials." },
  { name: "Versus Arthritis â€” Exercise advice", url: "https://versusarthritis.org/about-arthritis/managing-symptoms/exercise/", desc: "Free UK charity guidance on safe arthritis exercise, including tai chi." },
  { name: "UK healthcare â€” Tai chi", url: "https://www.nhs.uk/live-well/exercise/guide-to-tai-chi/", desc: "UK healthcare overview, cautions and how to find a class on the UK healthcare system Live Well site." },
];
...
const faqs = [
  ...
  { q: "Is tai chi safe for arthritis?", a: "For most people, yes. Tai chi is low-impact, slow, and weight-shifting rather than jarring â€” which is why NICE NG226 lists it as a safe therapeutic exercise for osteoarthritis. Pause practice during an acute flare, in the first 6 weeks after joint replacement surgery, or if you have severe balance issues without a chair or wall to support you. Otherwise, side effects are typically limited to mild post-session soreness that settles within 24 hours." },
...
const itemListJsonLd = {
  "@context": "https://schema.org",
  "@type": "ItemList",
  name: "Tai Chi for Arthritis â€” Topic Hub",
...
const howToJsonLd = {
  ...
  description:
    "Five core tai chi movements every NICE-aligned arthritis programme builds on â€” a slow, weight-shifted sequence for knee, hip, hand and back joint pain.",
  inLanguage: "en-GB",
  totalTime: "PT20M",
  ...
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        ...
        description="UK guide to tai chi for arthritis. NICE-recommended, evidence-based routines for knee, hip, hand and back pain â€” plus free UK healthcare and Versus Arthritis resources."
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-6 md:px-12 max-w-[1200px]">
          <div className="max-w-2xl mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">Free and low-cost ways to begin â€” no equipment, no membership.</p>
          </div>
          ...
          <Card className="mt-8 p-6 bg-primary/5 border-primary/20">
            ...
            <ol className="space-y-2 text-sm text-muted-foreground leading-relaxed list-decimal list-inside">
              <li><strong className="text-foreground">Week 1â€“2:</strong> 10 minutes a day of standing rooted + weight-shift drills. Follow our <Link to="/exercises/tai-chi-for-balance" className="text-primary underline underline-offset-2">15-minute beginner routine</Link>.</li>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-6 md:px-12 max-w-[1200px]">
          <div className="max-w-2xl mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">Two doors into the same practice â€” choose by how your joints feel right now.</p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-secondary/30 border-y border-border/15">
        <div className="container mx-auto px-6 md:px-12 max-w-[900px]">
          ...
          <FaqAccordion
            idPrefix="tai-chi-arthritis-faq"
